...
class TestNode(TestCase):
	...
	@data_provider([
		...
		('if True: ...', 'file_input.if_stmt.if_body.block', defs.Block, '', '__main__.if@1.if_body@2.block@4'),
		# Statement compound - Flow
		('if True: ...', 'file_input.if_stmt', defs.If, 'if@1', '__main__.if@1'),
		('if True: ...\nelif True: ...', 'file_input.if_stmt.elifs.elif_body', defs.ElseIf, 'else_if@7', '__main__.if@1.else_if@7'),
		('if True: ...\nelse: ...', 'file_input.if_stmt.else_body', defs.Else, 'else@7', '__main__.if@1.else@7'),
		...
		('if True:\n\tif True:\n\t\ta.b', 'file_input.if_stmt.if_body.block.if_stmt.if_body.block.getattr', defs.Relay, 'a.b', '__main__.if@1.if_body@2.if@5.if_body@6.a.b'),
		...
		('if True:\n\ta: int = 0', 'file_input.if_stmt.if_body.block.anno_assign.typed_var', defs.VarOfType, 'int', '__main__.if@1.if_body@2.int'),
	...
	@data_provider([
		...
		('if True: ...', 'file_input.if_stmt.if_body.const_true.', defs.Truthy, '__main__.if@1.if_body@2', '__main__'),
		('if True: ...\nelif True: ...', 'file_input.if_stmt.elifs.elif_body.const_true', defs.Truthy, '__main__.if@1.else_if@7', '__main__'),
		('if True: ...\nelse: ...', 'file_input.if_stmt.else_body.block.elipsis', defs.Elipsis, '__main__.if@1.else@7', '__main__'),
		...
		('if True:\n\ta = 0\nelif True:\n\ta = 1', 'file_input.if_stmt.if_body.block.assign.assign_namelist.var', defs.DeclLocalVar, '__main__.if@1.if_body@2', '__main__'),
		('if True:\n\ta = 0\nelif True:\n\ta = 1', 'file_input.if_stmt.elifs.elif_body.block.assign.assign_namelist.var', defs.DeclLocalVar, '__main__.if@1.else_if@13', '__main__'),
		# Primary - Name
	...
	@data_provider([
		...
		('if 1: ...', 'file_input.if_stmt.if_body.block', ''),
	...
	@data_provider([
		('file_input.class_def', [
			...
			'file_input.class_def.class_def_raw.block.function_def[1].function_def_raw.block.if_stmt[0].if_body.const_true',
			'file_input.class_def.class_def_raw.block.function_def[1].function_def_raw.block.if_stmt[0].if_body.block.elipsis',
			...
			'file_input.class_def.class_def_raw.block.function_def[1].function_def_raw.block.if_stmt[1].if_body.const_false',
			'file_input.class_def.class_def_raw.block.function_def[1].function_def_raw.block.if_stmt[1].if_body.block.elipsis',
