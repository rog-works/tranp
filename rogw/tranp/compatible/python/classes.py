...
class Integer:
	...
	def __not__(self, other: int | float | bool | str) -> bool: ...  # FIXME Anyを実装
	# arithmetic
...
class Dict(Generic[T_Key, T_Seq]):
	...
	def __iter__(self) -> Iterator[Pair[T_Key, T_Seq]]: ...
