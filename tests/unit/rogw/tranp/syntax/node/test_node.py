...
""",
			...
			[
				...
				'          | +-condition: <Truthy: __main__.A.__init__.if@57.if_clause@58.bool@59 (5, 6)..(5, 10)>',
				'          | +-statements:',
				'          | | +-<MoveAssign: __main__.A.__init__.if@57.if_clause@58.move_assign@61 (6, 4)..(6, 9)>',
				'          | | | +-receivers:',
				'          | | | | +-<DeclLocalVar: __main__.A.__init__.if@57.if_clause@58.n (6, 4)..(6, 5)>',
				'          | | | +-value: <Integer: __main__.A.__init__.if@57.if_clause@58.int@66 (6, 8)..(6, 9)>',
				'          | | +-<FuncCall: __main__.A.__init__.if@57.if_clause@58.func_call@68 (7, 4)..(7, 13)>',
				'          | |   +-calls: <Relay: __main__.A.__init__.if@57.if_clause@58.a.b (7, 4)..(7, 7)>',
				'          | |   | +-receiver: <Var: __main__.A.__init__.if@57.if_clause@58.a (7, 4)..(7, 5)>',
				'          | |   +-arguments:',
				'          | |     +-<Argument: __main__.A.__init__.if@57.if_clause@58.argument@76 (7, 8)..(7, 9)>',
				'          | |     | +-label: <Proxy: __main__.A.__init__.if@57.if_clause@58.Empty (0, 0)..(0, 0)>',
				'          | |     | +-value: <Var: __main__.A.__init__.if@57.if_clause@58.c (7, 8)..(7, 9)>',
				'          | |     +-<Argument: __main__.A.__init__.if@57.if_clause@58.argument@80 (7, 11)..(7, 12)>',
				'          | |       +-label: <Proxy: __main__.A.__init__.if@57.if_clause@58.Empty (0, 0)..(0, 0)>',
				'          | |       +-value: <Var: __main__.A.__init__.if@57.if_clause@58.d (7, 11)..(7, 12)>',
				'          | +-else_ifs:',
				'          | +-else_clause: <Empty: __main__.A.__init__.if@57.Empty (0, 0)..(0, 0)>',
				'          +-<For: __main__.A.__init__.for@86 (8, 3)..(11, 1)>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: __main__.A.__init__.for@86.key (8, 7)..(8, 10)>',
				'            | +-<DeclLocalVar: __main__.A.__init__.for@86.value (8, 12)..(8, 17)>',
				'            +-for_in: <ForIn: __main__.A.__init__.for@86.for_in@92 (8, 18)..(8, 37)>',
				'            | +-iterates: <FuncCall: __main__.A.__init__.for@86.func_call@93 (8, 21)..(8, 37)>',
				'            |   +-calls: <Relay: __main__.A.__init__.for@86.dict@95.items (8, 21)..(8, 35)>',
				'            |   | +-receiver: <Dict: __main__.A.__init__.for@86.dict@95 (8, 21)..(8, 29)>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: __main__.A.__init__.for@86.Pair@96 (8, 22)..(8, 28)>',
				'            |   |       +-first: <String: __main__.A.__init__.for@86.str@97 (8, 22)..(8, 25)>',
				'            |   |       +-second: <Integer: __main__.A.__init__.for@86.int@99 (8, 27)..(8, 28)>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: __main__.A.__init__.for@86.elipsis@105 (9, 4)..(9, 7)>',
			],
	),])
