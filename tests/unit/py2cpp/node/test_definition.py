...
class TestDefinition(TestCase):
	...
	@data_provider([
		...
		('self.a = 0', 'file_input.assign_stmt.assign.getattr', defs.ThisDeclVar),
		...
		('for a in arr: pass', 'file_input.for_stmt.name', defs.ForDeclVar),
		('try: ...\nexcept Exception as e: ...', 'file_input.try_stmt.except_clauses.except_clause.name', defs.CatchDeclVar),
	...
	@data_provider([
		('a(self.v)', 'file_input.funccall.arguments.argvalue.getattr', {'receiver': defs.ThisVar, 'property': defs.Variable}),
		...
		('self.a', 'file_input.getattr', {'receiver': defs.ThisVar, 'property': defs.Variable}),
		('self.a()', 'file_input.funccall.getattr', {'receiver': defs.ThisVar, 'property': defs.Variable}),
		('self.a[0]', 'file_input.getitem.getattr', {'receiver': defs.ThisVar, 'property': defs.Variable}),
