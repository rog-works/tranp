...
class TestClassify(TestCase):
	...
	@data_provider([
		...
		(by('__main__', 'assign_stmt.anno_assign.typed_var'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.int'),
		...
		(by('A.__init__.block', 'assign_stmt.anno_assign.typed_var'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.str'),
		(by('A.__init__.block', 'assign_stmt.anno_assign.string'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.str'),
		...
		(by('B.B2.block', 'assign_stmt.anno_assign.typed_var'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.str'),
		(by('B.B2.block', 'assign_stmt.anno_assign.string'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.str'),
		...
		(by('B.__init__.block', 'assign_stmt.anno_assign.typed_getitem'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.list'),
		(by('B.__init__.block', 'assign_stmt.anno_assign.list'), 'tests.unit.py2cpp.node.fixtures.test_symboldb_classes.list'),
