...
class TestPy2Cpp(TestCase):
	...
	@data_provider([
		...
		(_ast('CVarOps.local_move.block', 'if_stmt[4].if_body.block.assign[0]'), defs.MoveAssign, 'a = a;'),
		(_ast('CVarOps.local_move.block', 'if_stmt[4].if_body.block.assign[1]'), defs.MoveAssign, 'a = *(ap);'),
		(_ast('CVarOps.local_move.block', 'if_stmt[4].if_body.block.assign[2]'), defs.MoveAssign, 'a = *(asp);'),
		(_ast('CVarOps.local_move.block', 'if_stmt[4].if_body.block.assign[3]'), defs.MoveAssign, 'a = ar;'),
		(_ast('CVarOps.local_move.block', 'if_stmt[5].if_body.block.assign[0]'), defs.MoveAssign, 'ap = &(a);'),
		(_ast('CVarOps.local_move.block', 'if_stmt[5].if_body.block.assign[1]'), defs.MoveAssign, 'ap = ap;'),
		(_ast('CVarOps.local_move.block', 'if_stmt[5].if_body.block.assign[2]'), defs.MoveAssign, 'ap = (asp).get();'),
		(_ast('CVarOps.local_move.block', 'if_stmt[5].if_body.block.assign[3]'), defs.MoveAssign, 'ap = &(ar);'),
		(_ast('CVarOps.local_move.block', 'if_stmt[6].if_body.block.assign'), defs.MoveAssign, 'asp = asp;'),
		(_ast('CVarOps.local_move.block', 'if_stmt[7].if_body.block.assign[1]'), defs.MoveAssign, 'ar = a;'),  # XXX C++ではNGだが要件等 ※型推論のコストをかけてまでエラー判定が必要なのか微妙
		(_ast('CVarOps.local_move.block', 'if_stmt[7].if_body.block.assign[3]'), defs.MoveAssign, 'ar = *(ap);'),  # 〃
		(_ast('CVarOps.local_move.block', 'if_stmt[7].if_body.block.assign[5]'), defs.MoveAssign, 'ar = *(asp);'),  # 〃
		(_ast('CVarOps.local_move.block', 'if_stmt[7].if_body.block.assign[7]'), defs.MoveAssign, 'ar = ar;'),  # 〃
		...
		(_ast('Nullable.var_move.block', 'if_stmt.if_body.block.return_stmt'), defs.Return, 'return *(p);'),
