...
""",
			...
			[
				...
				'        +-statements:',
				'          +-<AnnoAssign: __main__.A.__init__.anno_assign@31>',
				'          | +-receiver: <DeclThisVar: __main__.A.n>',
				'          | +-var_type: <DictType: __main__.A.__init__.dict>',
				'          | | +-type_name: <VarOfType: __main__.A.__init__.dict>',
				'          | | +-key_type: <VarOfType: __main__.A.__init__.str>',
				'          | | +-value_type: <VarOfType: __main__.A.__init__.int>',
				'          | +-value: <Dict: __main__.A.__init__.dict@50>',
				'          |   +-items:',
				'          |     +-<Pair: __main__.A.__init__.Pair@51>',
				'          |       +-first: <String: __main__.A.__init__.str@52>',
				'          |       +-second: <Var: __main__.A.__init__.n>',
				...
				'          | | | +-receivers:',
				'          | | | | +-<DeclLocalVar: __main__.A.__init__.if.n>',
				'          | | | +-value: <Integer: __main__.A.__init__.if.int@65>',
				'          | | +-<FuncCall: __main__.A.__init__.if.func_call@67>',
				'          | |   +-calls: <Relay: __main__.A.__init__.if.a.b>',
				'          | |   | +-receiver: <Var: __main__.A.__init__.if.a>',
				'          | |   +-arguments:',
				'          | |     +-<Argument: __main__.A.__init__.if.argument@75>',
				'          | |     | +-label: <Proxy: __main__.A.__init__.if.Empty>',
				'          | |     | +-value: <Var: __main__.A.__init__.if.c>',
				'          | |     +-<Argument: __main__.A.__init__.if.argument@79>',
				'          | |       +-label: <Proxy: __main__.A.__init__.if.Empty>',
				'          | |       +-value: <Var: __main__.A.__init__.if.d>',
				'          | +-else_ifs:',
				'          | +-else_statements:',
				'          +-<For: __main__.A.__init__.for@85>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: __main__.A.__init__.for.key>',
				'            | +-<DeclLocalVar: __main__.A.__init__.for.value>',
				'            +-for_in: <ForIn: __main__.A.__init__.for.for_in@91>',
				'            | +-iterates: <FuncCall: __main__.A.__init__.for.func_call@92>',
				'            |   +-calls: <Relay: __main__.A.__init__.for.dict@94.items>',
				'            |   | +-receiver: <Dict: __main__.A.__init__.for.dict@94>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: __main__.A.__init__.for.Pair@95>',
				'            |   |       +-first: <String: __main__.A.__init__.for.str@96>',
				'            |   |       +-second: <Integer: __main__.A.__init__.for.int@98>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: __main__.A.__init__.for.elipsis@104>',
			],
	),])
