...
class TestNode(TestCase):
	...
	@data_provider([
		# ClassKind
		('def func() -> None: ...', 'file_input.function_def', defs.Function, '__main__.func', '__main__.func.func'),
		('class A:\n\t@classmethod\n\tdef c_method(cls) -> None: ...', 'file_input.class_def.class_def_raw.block.function_def', defs.ClassMethod, '__main__.A.c_method', '__main__.A.c_method.c_method'),
		('class A:\n\tdef __init__(self) -> None: ...', 'file_input.class_def.class_def_raw.block.function_def', defs.Constructor, '__main__.A.__init__', '__main__.A.__init__.__init__'),
		('class A:\n\tdef method(self) -> None: ...', 'file_input.class_def.class_def_raw.block.function_def', defs.Method, '__main__.A.method', '__main__.A.method.method'),
		('class A:\n\tdef method(self) -> None:\n\t\tdef closure() -> None: ...', 'file_input.class_def.class_def_raw.block.function_def.function_def_raw.block.function_def', defs.Closure, '__main__.A.method.closure', '__main__.A.method.closure.closure'),
		('class A: ...', 'file_input.class_def', defs.Class, '__main__.A', '__main__.A.A'),
		('class E(CEnum): ...', 'file_input.enum_def', defs.Enum, '__main__.E', '__main__.E.E'),
		# Declable
		('class A:\n\ta: int = 0', 'file_input.class_def.class_def_raw.block.assign_stmt.anno_assign.var', defs.ClassDeclVar, '__main__.A.a', '__main__.a'),
		('class A:\n\tdef __init__(self) -> None:\n\t\tself.a: int = 0', 'file_input.class_def.class_def_raw.block.function_def.function_def_raw.block.assign_stmt.anno_assign.getattr', defs.ThisDeclVar, '__main__.A.a', '__main__.A.A.a'),
		...
		# Type
		('a: int = 0', 'file_input.assign_stmt.anno_assign.typed_var', defs.GeneralType, '__main__.int', '__main__.int'),
		('a: list[int] = []', 'file_input.assign_stmt.anno_assign.typed_getitem', defs.ListType, '__main__.list', '__main__.list'),
		('a: dict[str, int] = {}', 'file_input.assign_stmt.anno_assign.typed_getitem', defs.DictType, '__main__.dict', '__main__.dict'),
		('a: Callable[[int], None] = {}', 'file_input.assign_stmt.anno_assign.typed_getitem', defs.CallableType, '__main__.Callable', '__main__.Callable'),
		('a: int | str = 0', 'file_input.assign_stmt.anno_assign.typed_or_expr', defs.UnionType, '__main__.int', '__main__.int'),  # FIXME UnionTypeを表現できない
		('def func() -> None: ...', 'file_input.function_def.function_def_raw.return_type.typed_none', defs.NullType, '__main__.None', '__main__.None'),
		# Literal
		('1', 'file_input.number', defs.Integer, '__main__.int', '__main__.int'),
		('1.0', 'file_input.number', defs.Float, '__main__.float', '__main__.float'),
		("'string'", 'file_input.string', defs.String, '__main__.str', '__main__.str'),
		('True', 'file_input.const_true', defs.Truthy, '__main__.bool', '__main__.bool'),
		('False', 'file_input.const_false', defs.Falsy, '__main__.bool', '__main__.bool'),
		('{1: 2}', 'file_input.dict.key_value', defs.Pair, '__main__.pair_', '__main__.pair_'),
		('[1]', 'file_input.list', defs.List, '__main__.list', '__main__.list'),
		('{1: 2}', 'file_input.dict', defs.Dict, '__main__.dict', '__main__.dict'),
		('None', 'file_input.const_none', defs.Null, '__main__.None', '__main__.None'),
	])
	def test_domain_id_and_domain_name(self, source: str, full_path: str, types: type[T_Node], expected_id: bool, expected_name: bool) -> None:
		node = self.fixture.custom_nodes(source).by(full_path)
		self.assertEqual(type(node), types)
		self.assertEqual(cast(IDomainName, node).domain_id, expected_id)
