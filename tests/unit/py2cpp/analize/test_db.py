...
class TestSymbolDB(TestCase):
	...
	@data_provider([
		({
			...
			'__main__.B.func2.for.i': 'py2cpp.compatible.python.template.T_Seq',  # FIXME 追って修正
			...
			'__main__.B.func2.for.func_call@333': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Iterator',
