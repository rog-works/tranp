...
class TestPy2Cpp(TestCase):
	...
	@data_provider([
		...
		('ForFunction.Method.keys', '', defs.Method, BlockExpects.ForIteratorListTuple),
		...
		('ForBinaryOperator.op_to_assign', 'function_def_raw.block.assign[3]', defs.MoveAssign, 'double f = d * 0.0;'),
