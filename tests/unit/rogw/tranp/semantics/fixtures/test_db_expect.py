def expected_symbols() -> dict:
	return {
		...
		'__main__.Z': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Z',
		...
		'__main__.AliasOps.func.z2_in_x': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.X',
		'__main__.AliasOps.func.new_z2_in_x': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.X',
		...
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.X': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.X',
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Y': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Y',
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Z': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Z',
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.X.nx': 'rogw.tranp.compatible.python.classes.int',
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Y.ny': 'rogw.tranp.compatible.python.classes.int',
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Y.x': 'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.X',
		'tests.unit.rogw.tranp.semantics.fixtures.test_db_xyz.Z.nz': 'rogw.tranp.compatible.python.classes.int',
