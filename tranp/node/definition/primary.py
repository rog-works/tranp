...
from tranp.node.definition.literal import Literal
...
from tranp.node.promise import IDeclare
...
class Super(FuncCall):
	...
	def super_class_symbol(self) -> Type:
		from tranp.node.definition.statement_compound import Class  # FIXME 循環参照
