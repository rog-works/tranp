...
class TestNode(TestCase):
	...
	@data_provider([
		...
		('def f[T]() -> None: ...', 'file_input.function_def.function_def_raw.inline_template_assigns.template_assign', defs.TemplateClass, 'T', '__main__#f.T'),
		# Elements
		...
		('def f[T: int]() -> None: ...', 'file_input.function_def.function_def_raw.inline_template_assigns.template_assign.template_assign_bound.typed_var', defs.VarOfType, 'int', '__main__#f.T.int'),
		# Primary - FuncCall
	...
	@data_provider([
		...
		('def f[T]() -> None: ...', 'file_input.function_def.function_def_raw.inline_template_assigns.template_assign', defs.TemplateClass, '__main__#f', '__main__#f'),
		# Elements
		...
		('def f[T: int]() -> None: ...', 'file_input.function_def.function_def_raw.inline_template_assigns.template_assign.template_assign_bound.typed_var', defs.VarOfType, '__main__#f.T', '__main__#f.T'),
		# Primary - FuncCall
