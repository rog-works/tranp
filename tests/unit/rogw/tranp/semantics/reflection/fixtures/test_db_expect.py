def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		'rogw.tranp.compatible.libralies.type#Any': ('rogw.tranp.compatible.libralies.type#Any', 'Any'),
		'rogw.tranp.compatible.libralies.type#Generic': ('rogw.tranp.compatible.libralies.type#Generic', 'Generic'),
		'rogw.tranp.compatible.libralies.type#TypeVar': ('rogw.tranp.compatible.libralies.type#TypeVar', 'TypeVar'),
		...
		'rogw.tranp.compatible.libralies.type#type.__eq__': ('rogw.tranp.compatible.libralies.type#type.__eq__', '__eq__(type<T>, type<Any>) -> bool'),
		'rogw.tranp.compatible.libralies.type#type.__not__': ('rogw.tranp.compatible.libralies.type#type.__not__', '__not__(type<T>, type<Any>) -> bool'),
		'rogw.tranp.compatible.libralies.type#type.__eq__.self': ('rogw.tranp.compatible.libralies.type#type', 'type<T>'),
		'rogw.tranp.compatible.libralies.type#type.__eq__.other': ('rogw.tranp.compatible.libralies.type#type', 'type<Any>'),
		'rogw.tranp.compatible.libralies.type#type.__not__.self': ('rogw.tranp.compatible.libralies.type#type', 'type<T>'),
		'rogw.tranp.compatible.libralies.type#type.__not__.other': ('rogw.tranp.compatible.libralies.type#type', 'type<Any>'),
