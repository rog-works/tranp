...
class TestPy2Cpp(TestCase):
	...
	@data_provider([
		...
		('CVarOps.binary_calc', 'function_def_raw.block.assign[4]', defs.MoveAssign, 'Sub calc = a + (*(ap)) * (*(asp)) - ar / a;'),
		('CVarOps.binary_calc', 'function_def_raw.block.assign[5]', defs.MoveAssign, 'bool is_a = a == (*(ap)) == (*(asp)) == ar;'),
		('CVarOps.binary_calc', 'function_def_raw.block.assign[6]', defs.MoveAssign, 'bool is_not_a = a != (*(ap)) != (*(asp)) != ar;'),
		('CVarOps.binary_calc', 'function_def_raw.block.assign[7]', defs.MoveAssign, 'bool is_null = apn == nullptr && apn != nullptr;'),
