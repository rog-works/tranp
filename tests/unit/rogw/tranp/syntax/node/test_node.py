...
""",
			...
			[
				...
				'        +-symbol: <TypesName: @12 __main__#A.__init__.__init__ (3, 6)..(3, 14)>',
				'        +-decorators:',
				'        +-template_params:',
				'        +-parameters:',
				'        | +-<Parameter: @16 __main__#A.__init__.parameter@16 (3, 15)..(3, 19)>',
				'        | | +-symbol: <DeclThisParam: @18 __main__#A.__init__.self (3, 15)..(3, 19)>',
				'        | | +-var_type: <Proxy: @-1 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        | | +-default_value: <Empty: @20 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        | +-<Parameter: @21 __main__#A.__init__.parameter@21 (3, 21)..(3, 27)>',
				'        |   +-symbol: <DeclParam: @23 __main__#A.__init__.n (3, 21)..(3, 22)>',
				'        |   +-var_type: <VarOfType: @25 __main__#A.__init__.int (3, 24)..(3, 27)>',
				'        |   +-default_value: <Empty: @28 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        +-return_type: <NullType: @31 __main__#A.__init__.None (3, 32)..(3, 36)>',
				'        +-comment: <Proxy: @10 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        +-statements:',
				'          +-<AnnoAssign: @33 __main__#A.__init__.anno_assign@33 (4, 3)..(4, 38)>',
				'          | +-receiver: <DeclThisVar: @35 __main__#A.n (4, 3)..(4, 9)>',
				'          | +-var_type: <DictType: @41 __main__#A.__init__.dict (4, 11)..(4, 25)>',
				'          | | +-type_name: <VarOfType: @42 __main__#A.__init__.dict (4, 11)..(4, 15)>',
				'          | | +-key_type: <VarOfType: @46 __main__#A.__init__.str (4, 16)..(4, 19)>',
				'          | | +-value_type: <VarOfType: @49 __main__#A.__init__.int (4, 21)..(4, 24)>',
				'          | +-value: <Dict: @52 __main__#A.__init__.dict@52 (4, 28)..(4, 38)>',
				'          |   +-items:',
				'          |     +-<Pair: @53 __main__#A.__init__.Pair@53 (4, 29)..(4, 37)>',
				'          |       +-first: <String: @54 __main__#A.__init__.str@54 (4, 29)..(4, 34)>',
				'          |       +-second: <Var: @56 __main__#A.__init__.n (4, 36)..(4, 37)>',
				'          +-<If: @59 __main__#A.__init__.if@59 (5, 3)..(8, 3)>',
				'          | +-condition: <Truthy: @61 __main__#A.__init__.if@59.if_clause@60.bool@61 (5, 6)..(5, 10)>',
				'          | +-statements:',
				'          | | +-<MoveAssign: @63 __main__#A.__init__.if@59.if_clause@60.move_assign@63 (6, 4)..(6, 9)>',
				'          | | | +-receivers:',
				'          | | | | +-<DeclLocalVar: @65 __main__#A.__init__.if@59.if_clause@60.n (6, 4)..(6, 5)>',
				'          | | | +-value: <Integer: @68 __main__#A.__init__.if@59.if_clause@60.int@68 (6, 8)..(6, 9)>',
				'          | | +-<FuncCall: @70 __main__#A.__init__.if@59.if_clause@60.func_call@70 (7, 4)..(7, 13)>',
				'          | |   +-calls: <Relay: @71 __main__#A.__init__.if@59.if_clause@60.a.b (7, 4)..(7, 7)>',
				'          | |   | +-receiver: <Var: @72 __main__#A.__init__.if@59.if_clause@60.a (7, 4)..(7, 5)>',
				'          | |   +-arguments:',
				'          | |     +-<Argument: @78 __main__#A.__init__.if@59.if_clause@60.argument@78 (7, 8)..(7, 9)>',
				'          | |     | +-label: <Proxy: @-1 __main__#A.__init__.if@59.if_clause@60.Empty (0, 0)..(0, 0)>',
				'          | |     | +-value: <Var: @79 __main__#A.__init__.if@59.if_clause@60.c (7, 8)..(7, 9)>',
				'          | |     +-<Argument: @82 __main__#A.__init__.if@59.if_clause@60.argument@82 (7, 11)..(7, 12)>',
				'          | |       +-label: <Proxy: @-1 __main__#A.__init__.if@59.if_clause@60.Empty (0, 0)..(0, 0)>',
				'          | |       +-value: <Var: @83 __main__#A.__init__.if@59.if_clause@60.d (7, 11)..(7, 12)>',
				'          | +-else_ifs:',
				'          | +-else_clause: <Empty: @89 __main__#A.__init__.if@59.Empty (0, 0)..(0, 0)>',
				'          +-<For: @90 __main__#A.__init__.for@90 (8, 3)..(11, 1)>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: @92 __main__#A.__init__.for@90.key (8, 7)..(8, 10)>',
				'            | +-<DeclLocalVar: @94 __main__#A.__init__.for@90.value (8, 12)..(8, 17)>',
				'            +-for_in: <ForIn: @96 __main__#A.__init__.for@90.for_in@96 (8, 18)..(8, 37)>',
				'            | +-iterates: <FuncCall: @97 __main__#A.__init__.for@90.func_call@97 (8, 21)..(8, 37)>',
				'            |   +-calls: <Relay: @98 __main__#A.__init__.for@90.dict@99.items (8, 21)..(8, 35)>',
				'            |   | +-receiver: <Dict: @99 __main__#A.__init__.for@90.dict@99 (8, 21)..(8, 29)>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: @100 __main__#A.__init__.for@90.Pair@100 (8, 22)..(8, 28)>',
				'            |   |       +-first: <String: @101 __main__#A.__init__.for@90.str@101 (8, 22)..(8, 25)>',
				'            |   |       +-second: <Integer: @103 __main__#A.__init__.for@90.int@103 (8, 27)..(8, 28)>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: @109 __main__#A.__init__.for@90.elipsis@109 (9, 4)..(9, 7)>',
			],
	),])
