...
from tranp.node.definition.primary import FuncCall, ImportPath, Indexer, Reference, Declable, Type, Var
from tranp.node.definition.terminal import Empty, Terminal
from tranp.node.embed import Meta, accept_tags, expandable
from tranp.node.interface import ITerminal
