def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.__init__': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.__init__', '__init__(DeclThisVar) -> None'),
