def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2', 'G2'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v_ref': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v_ref', 'v_ref(G2) -> None'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v_ref.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2', 'G2'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v_ref.gn': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v_ref.gn_v': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v_ref.super_v': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
