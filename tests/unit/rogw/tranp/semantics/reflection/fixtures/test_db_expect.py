def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'rogw.tranp.compatible.cpp.classes#char': ('rogw.tranp.compatible.cpp.classes#char', 'char'),
		'rogw.tranp.compatible.cpp.classes#wchar_t': ('rogw.tranp.compatible.cpp.classes#wchar_t', 'wchar_t'),
		'rogw.tranp.compatible.cpp.classes#byte': ('rogw.tranp.compatible.cpp.classes#byte', 'byte'),
		'rogw.tranp.compatible.cpp.classes#int8': ('rogw.tranp.compatible.cpp.classes#int8', 'int8'),
		'rogw.tranp.compatible.cpp.classes#uint8': ('rogw.tranp.compatible.cpp.classes#uint8', 'uint8'),
		'rogw.tranp.compatible.cpp.classes#int32': ('rogw.tranp.compatible.cpp.classes#int32', 'int32'),
		'rogw.tranp.compatible.cpp.classes#int64': ('rogw.tranp.compatible.cpp.classes#int64', 'int64'),
		'rogw.tranp.compatible.cpp.classes#uint32': ('rogw.tranp.compatible.cpp.classes#uint32', 'uint32'),
		'rogw.tranp.compatible.cpp.classes#uint64': ('rogw.tranp.compatible.cpp.classes#uint64', 'uint64'),
		'rogw.tranp.compatible.cpp.classes#double': ('rogw.tranp.compatible.cpp.classes#double', 'double'),
		'rogw.tranp.compatible.cpp.classes#void': ('rogw.tranp.compatible.cpp.classes#void', 'void=object'),
		'rogw.tranp.compatible.cpp.classes#TypeAlias': ('typing#TypeAlias', 'TypeAlias'),
		'abc#ABCMeta': ('abc#ABCMeta', 'ABCMeta'),
		'abc#abstractmethod': ('abc#abstractmethod', 'abstractmethod(T) -> T'),
		'abc#T': ('rogw.tranp.compatible.python.template#T', 'T'),
		'abc#abstractmethod.wrapped': ('rogw.tranp.compatible.python.template#T', 'T'),
		'rogw.tranp.compatible.cpp.object#T': ('rogw.tranp.compatible.cpp.object#T', 'T'),
		'rogw.tranp.compatible.cpp.object#T_co': ('rogw.tranp.compatible.cpp.object#T_co', 'T_co'),
		'rogw.tranp.compatible.cpp.object#T_New': ('rogw.tranp.compatible.cpp.object#T_New', 'T_New'),
		'rogw.tranp.compatible.cpp.object#CVar': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.on': ('rogw.tranp.compatible.cpp.object#CVar.on', 'on(CVar<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVar.raw': ('rogw.tranp.compatible.cpp.object#CVar.raw', 'raw(CVar<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVar._origin_raw': ('rogw.tranp.compatible.cpp.object#CVar._origin_raw', '_origin_raw(CVar<T_co>) -> Union<T_co, None>'),
		'rogw.tranp.compatible.cpp.object#CVar.hex': ('rogw.tranp.compatible.cpp.object#CVar.hex', 'hex(CVar<T_co>) -> str'),
		'rogw.tranp.compatible.cpp.object#CVar.__eq__': ('rogw.tranp.compatible.cpp.object#CVar.__eq__', '__eq__(CVar<T_co>, Self) -> bool'),
		'rogw.tranp.compatible.cpp.object#CVar.__ne__': ('rogw.tranp.compatible.cpp.object#CVar.__ne__', '__ne__(CVar<T_co>, Self) -> bool'),
		'rogw.tranp.compatible.cpp.object#CVar.__hash__': ('rogw.tranp.compatible.cpp.object#CVar.__hash__', '__hash__(CVar<T_co>) -> int'),
		'rogw.tranp.compatible.cpp.object#CVar.__repr__': ('rogw.tranp.compatible.cpp.object#CVar.__repr__', '__repr__(CVar<T_co>) -> str'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull': ('rogw.tranp.compatible.cpp.object#CVarNotNull', 'CVarNotNull<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.__init__': ('rogw.tranp.compatible.cpp.object#CVarNotNull.__init__', '__init__(CVarNotNull<T_co>, T_co) -> None'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.on': ('rogw.tranp.compatible.cpp.object#CVarNotNull.on', 'on(CVarNotNull<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.raw': ('rogw.tranp.compatible.cpp.object#CVarNotNull.raw', 'raw(CVarNotNull<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull._origin_raw': ('rogw.tranp.compatible.cpp.object#CVarNotNull._origin_raw', '_origin_raw(CVarNotNull<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNullable': ('rogw.tranp.compatible.cpp.object#CVarNullable', 'CVarNullable<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.__init__': ('rogw.tranp.compatible.cpp.object#CVarNullable.__init__', '__init__(CVarNullable<T_co>, Union<T_co, None>) -> None'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.on': ('rogw.tranp.compatible.cpp.object#CVarNullable.on', 'on(CVarNullable<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.raw': ('rogw.tranp.compatible.cpp.object#CVarNullable.raw', 'raw(CVarNullable<T_co>) -> T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNullable._origin_raw': ('rogw.tranp.compatible.cpp.object#CVarNullable._origin_raw', '_origin_raw(CVarNullable<T_co>) -> Union<T_co, None>'),
		'rogw.tranp.compatible.cpp.object#CP': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.new': ('rogw.tranp.compatible.cpp.object#CP.new', 'new(type<CP<T_co>>, T_New) -> CP<T_New>'),
		'rogw.tranp.compatible.cpp.object#CRef': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.ref': ('rogw.tranp.compatible.cpp.object#CP.ref', 'ref(CP<T_co>) -> CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CPConst': ('rogw.tranp.compatible.cpp.object#CPConst', 'CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.const': ('rogw.tranp.compatible.cpp.object#CP.const', 'const(CP<T_co>) -> CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.__add__': ('rogw.tranp.compatible.cpp.object#CP.__add__', '__add__(CP<T_co>, int) -> int'),
		'rogw.tranp.compatible.cpp.object#CP.__sub__': ('rogw.tranp.compatible.cpp.object#CP.__sub__', '__sub__(CP<T_co>, CP<T_co>) -> int'),
		'rogw.tranp.compatible.cpp.object#CSP': ('rogw.tranp.compatible.cpp.object#CSP', 'CSP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.empty': ('rogw.tranp.compatible.cpp.object#CSP.empty', 'empty(type<CSP<T_co>>) -> Union<CSP<T_co>, None>'),
		'rogw.tranp.compatible.cpp.object#CSP.new': ('rogw.tranp.compatible.cpp.object#CSP.new', 'new(type<CSP<T_co>>, T_New) -> CSP<T_New>'),
		'rogw.tranp.compatible.cpp.object#CSP.ref': ('rogw.tranp.compatible.cpp.object#CSP.ref', 'ref(CSP<T_co>) -> CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.addr': ('rogw.tranp.compatible.cpp.object#CSP.addr', 'addr(CSP<T_co>) -> CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSPConst': ('rogw.tranp.compatible.cpp.object#CSPConst', 'CSPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.const': ('rogw.tranp.compatible.cpp.object#CSP.const', 'const(CSP<T_co>) -> CSPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.addr': ('rogw.tranp.compatible.cpp.object#CRef.addr', 'addr(CRef<T_co>) -> CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRefConst': ('rogw.tranp.compatible.cpp.object#CRefConst', 'CRefConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.const': ('rogw.tranp.compatible.cpp.object#CRef.const', 'const(CRef<T_co>) -> CRefConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.copy_proxy': ('rogw.tranp.compatible.cpp.object#CRef.copy_proxy', 'copy_proxy(CRef<T_co>, CRef<T_co>) -> None'),
		'rogw.tranp.compatible.cpp.object#CPConst.ref': ('rogw.tranp.compatible.cpp.object#CPConst.ref', 'ref(CPConst<T_co>) -> CRefConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSPConst.ref': ('rogw.tranp.compatible.cpp.object#CSPConst.ref', 'ref(CSPConst<T_co>) -> CRefConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSPConst.addr': ('rogw.tranp.compatible.cpp.object#CSPConst.addr', 'addr(CSPConst<T_co>) -> CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRefConst.addr': ('rogw.tranp.compatible.cpp.object#CRefConst.addr', 'addr(CRefConst<T_co>) -> CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRawConst': ('rogw.tranp.compatible.cpp.object#CRawConst', 'CRawConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRawConst.ref': ('rogw.tranp.compatible.cpp.object#CRawConst.ref', 'ref(CRawConst<T_co>) -> CRefConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRawConst.addr': ('rogw.tranp.compatible.cpp.object#CRawConst.addr', 'addr(CRawConst<T_co>) -> CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRaw': ('rogw.tranp.compatible.cpp.object#CRaw', 'CRaw<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRaw.ref': ('rogw.tranp.compatible.cpp.object#CRaw.ref', 'ref(CRaw<T_co>) -> CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRaw.addr': ('rogw.tranp.compatible.cpp.object#CRaw.addr', 'addr(CRaw<T_co>) -> CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#ABCMeta': ('abc#ABCMeta', 'ABCMeta'),
		'rogw.tranp.compatible.cpp.object#abstractmethod': ('abc#abstractmethod', 'abstractmethod(T) -> T'),
		'rogw.tranp.compatible.cpp.object#Callable': ('collections.abc#Callable', 'Callable'),
		'rogw.tranp.compatible.cpp.object#Generic': ('typing#Generic', 'Generic'),
		'rogw.tranp.compatible.cpp.object#Self': ('typing#Self', 'Self'),
		'rogw.tranp.compatible.cpp.object#TypeVar': ('typing#TypeVar', 'TypeVar'),
		'rogw.tranp.compatible.cpp.object#override': ('typing#override', 'override(T) -> T'),
		'rogw.tranp.compatible.cpp.object#CVar.on.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.raw.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar._origin_raw.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.hex.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.__eq__.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.__eq__.other': ('typing#Self', 'Self'),
		'rogw.tranp.compatible.cpp.object#CVar.__ne__.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.__ne__.other': ('typing#Self', 'Self'),
		'rogw.tranp.compatible.cpp.object#CVar.__hash__.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVar.__repr__.self': ('rogw.tranp.compatible.cpp.object#CVar', 'CVar<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.__init__.self': ('rogw.tranp.compatible.cpp.object#CVarNotNull', 'CVarNotNull<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.__init__.origin': ('rogw.tranp.compatible.cpp.object#T_co', 'T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.on.self': ('rogw.tranp.compatible.cpp.object#CVarNotNull', 'CVarNotNull<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull.raw.self': ('rogw.tranp.compatible.cpp.object#CVarNotNull', 'CVarNotNull<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull._origin_raw.self': ('rogw.tranp.compatible.cpp.object#CVarNotNull', 'CVarNotNull<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNotNull._origin': ('rogw.tranp.compatible.cpp.object#T_co', 'T_co'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.__init__.self': ('rogw.tranp.compatible.cpp.object#CVarNullable', 'CVarNullable<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.__init__.origin': ('typing#Union', 'Union<T_co, None>'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.on.self': ('rogw.tranp.compatible.cpp.object#CVarNullable', 'CVarNullable<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNullable.raw.self': ('rogw.tranp.compatible.cpp.object#CVarNullable', 'CVarNullable<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNullable._origin_raw.self': ('rogw.tranp.compatible.cpp.object#CVarNullable', 'CVarNullable<T_co>'),
		'rogw.tranp.compatible.cpp.object#CVarNullable._origin': ('typing#Union', 'Union<T_co, None>'),
		'rogw.tranp.compatible.cpp.object#CP.new.cls': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.new.origin': ('rogw.tranp.compatible.cpp.object#T_New', 'T_New'),
		'rogw.tranp.compatible.cpp.object#CP.ref.self': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.const.self': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.__add__.self': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.__add__.offset': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'rogw.tranp.compatible.cpp.object#CP.__sub__.self': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CP.__sub__.other': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.empty.cls': ('rogw.tranp.compatible.cpp.object#CSP', 'CSP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.new.cls': ('rogw.tranp.compatible.cpp.object#CSP', 'CSP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.new.origin': ('rogw.tranp.compatible.cpp.object#T_New', 'T_New'),
		'rogw.tranp.compatible.cpp.object#CSP.ref.self': ('rogw.tranp.compatible.cpp.object#CSP', 'CSP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.addr.self': ('rogw.tranp.compatible.cpp.object#CSP', 'CSP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSP.const.self': ('rogw.tranp.compatible.cpp.object#CSP', 'CSP<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.addr.self': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.const.self': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.copy_proxy.self': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.copy_proxy.via': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.copy_proxy.if@1386.if_clause@1387.copy_origin': ('collections.abc#Callable', 'Callable<CRef<T_co>, None>'),
		'rogw.tranp.compatible.cpp.object#CPConst.ref.self': ('rogw.tranp.compatible.cpp.object#CPConst', 'CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSPConst.ref.self': ('rogw.tranp.compatible.cpp.object#CSPConst', 'CSPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CSPConst.addr.self': ('rogw.tranp.compatible.cpp.object#CSPConst', 'CSPConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRefConst.addr.self': ('rogw.tranp.compatible.cpp.object#CRefConst', 'CRefConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRawConst.ref.self': ('rogw.tranp.compatible.cpp.object#CRawConst', 'CRawConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRawConst.addr.self': ('rogw.tranp.compatible.cpp.object#CRawConst', 'CRawConst<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRaw.ref.self': ('rogw.tranp.compatible.cpp.object#CRaw', 'CRaw<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRaw.addr.self': ('rogw.tranp.compatible.cpp.object#CRaw', 'CRaw<T_co>'),
		'rogw.tranp.compatible.cpp.convertion#T': ('rogw.tranp.compatible.cpp.convertion#T', 'T'),
		'rogw.tranp.compatible.cpp.convertion#CastAddrProtocol': ('rogw.tranp.compatible.cpp.convertion#CastAddrProtocol', 'CastAddrProtocol'),
		'rogw.tranp.compatible.cpp.convertion#CastAddrProtocol.__cast_addr__': ('rogw.tranp.compatible.cpp.convertion#CastAddrProtocol.__cast_addr__', '__cast_addr__(CastAddrProtocol, type<T>) -> CP<T>'),
		'rogw.tranp.compatible.cpp.convertion#cast_addr': ('rogw.tranp.compatible.cpp.convertion#cast_addr', 'cast_addr(type<T>, CP<Any>) -> CP<T>'),
		'rogw.tranp.compatible.cpp.convertion#const_cast': ('rogw.tranp.compatible.cpp.convertion#const_cast', 'const_cast(type<CP<T>>, CPConst<T>) -> CP<T>'),
		'rogw.tranp.compatible.cpp.convertion#immutable_const_cast': ('rogw.tranp.compatible.cpp.convertion#immutable_const_cast', 'immutable_const_cast(type<T>, T) -> T'),
		'rogw.tranp.compatible.cpp.convertion#sizeof': ('rogw.tranp.compatible.cpp.convertion#sizeof', 'sizeof(type<Any>) -> int'),
		'rogw.tranp.compatible.cpp.convertion#Any': ('typing#Any', 'Any'),
		'rogw.tranp.compatible.cpp.convertion#Protocol': ('typing#Protocol', 'Protocol'),
		'rogw.tranp.compatible.cpp.convertion#TypeVar': ('typing#TypeVar', 'TypeVar'),
		'rogw.tranp.compatible.cpp.convertion#cast': ('typing#cast', 'cast(type<T>, Any) -> T'),
		'rogw.tranp.compatible.cpp.convertion#void': ('rogw.tranp.compatible.cpp.classes#void', 'void=object'),
		'rogw.tranp.compatible.cpp.convertion#CP': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.convertion#CPConst': ('rogw.tranp.compatible.cpp.object#CPConst', 'CPConst<T_co>'),
		'rogw.tranp.compatible.cpp.convertion#CastAddrProtocol.__cast_addr__.self': ('rogw.tranp.compatible.cpp.convertion#CastAddrProtocol', 'CastAddrProtocol'),
		'rogw.tranp.compatible.cpp.convertion#CastAddrProtocol.__cast_addr__.to_origin': ('rogw.tranp.compatible.libralies.type#type', 'type<T>'),
		'rogw.tranp.compatible.cpp.convertion#cast_addr.to_origin': ('rogw.tranp.compatible.libralies.type#type', 'type<T>'),
		'rogw.tranp.compatible.cpp.convertion#cast_addr.value_at': ('rogw.tranp.compatible.cpp.object#CP', 'CP<Any>'),
		'rogw.tranp.compatible.cpp.convertion#const_cast.entity_type': ('rogw.tranp.compatible.libralies.type#type', 'type<CP<T>>'),
		'rogw.tranp.compatible.cpp.convertion#const_cast.value_at': ('rogw.tranp.compatible.cpp.object#CPConst', 'CPConst<T>'),
		'rogw.tranp.compatible.cpp.convertion#immutable_const_cast.value_type': ('rogw.tranp.compatible.libralies.type#type', 'type<T>'),
		'rogw.tranp.compatible.cpp.convertion#immutable_const_cast.value': ('rogw.tranp.compatible.cpp.convertion#T', 'T'),
		'rogw.tranp.compatible.cpp.convertion#sizeof.origin': ('rogw.tranp.compatible.libralies.type#type', 'type<Any>'),
		'rogw.tranp.lang.annotation#T': ('rogw.tranp.lang.annotation#T', 'T'),
		'rogw.tranp.lang.annotation#implements': ('rogw.tranp.lang.annotation#implements', 'implements(T) -> T'),
		'rogw.tranp.lang.annotation#duck_typed.decorator': ('rogw.tranp.lang.annotation#duck_typed.decorator', 'decorator(T) -> T'),
		'rogw.tranp.lang.annotation#duck_typed': ('rogw.tranp.lang.annotation#duck_typed', 'duck_typed(Any) -> Callable<T, T>'),
		'rogw.tranp.lang.annotation#deprecated': ('rogw.tranp.lang.annotation#deprecated', 'deprecated(T) -> T'),
		'rogw.tranp.lang.annotation#injectable': ('rogw.tranp.lang.annotation#injectable', 'injectable(T) -> T'),
		'rogw.tranp.lang.annotation#Callable': ('collections.abc#Callable', 'Callable'),
		'rogw.tranp.lang.annotation#Any': ('typing#Any', 'Any'),
		'rogw.tranp.lang.annotation#TypeVar': ('typing#TypeVar', 'TypeVar'),
		'rogw.tranp.lang.annotation#implements.wrapped': ('rogw.tranp.lang.annotation#T', 'T'),
		'rogw.tranp.lang.annotation#duck_typed.decorator.wrapped': ('rogw.tranp.lang.annotation#T', 'T'),
		'rogw.tranp.lang.annotation#duck_typed.protocol': ('typing#Any', 'Any'),
		'rogw.tranp.lang.annotation#deprecated.wrapped': ('rogw.tranp.lang.annotation#T', 'T'),
		'rogw.tranp.lang.annotation#injectable.wrapped': ('rogw.tranp.lang.annotation#T', 'T'),
		...
		'rogw.tranp.compatible.cpp.enum#CEnum.__eq__': ('rogw.tranp.compatible.cpp.enum#CEnum.__eq__', '__eq__(CEnum, Union<Self, int>) -> bool'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__or__': ('rogw.tranp.compatible.cpp.enum#CEnum.__or__', '__or__(CEnum, Self) -> Self'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__ror__': ('rogw.tranp.compatible.cpp.enum#CEnum.__ror__', '__ror__(CEnum, Self) -> Self'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__hash__': ('rogw.tranp.compatible.cpp.enum#CEnum.__hash__', '__hash__(CEnum) -> int'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__cast_addr__': ('rogw.tranp.compatible.cpp.enum#CEnum.__cast_addr__', '__cast_addr__(CEnum, type<T>) -> CP<T>'),
		'rogw.tranp.compatible.cpp.enum#Enum': ('enum#Enum', 'Enum'),
		'rogw.tranp.compatible.cpp.enum#Self': ('typing#Self', 'Self'),
		'rogw.tranp.compatible.cpp.enum#CastAddrProtocol': ('rogw.tranp.compatible.cpp.convertion#CastAddrProtocol', 'CastAddrProtocol'),
		'rogw.tranp.compatible.cpp.enum#T': ('rogw.tranp.compatible.cpp.convertion#T', 'T'),
		'rogw.tranp.compatible.cpp.enum#CP': ('rogw.tranp.compatible.cpp.object#CP', 'CP<T_co>'),
		'rogw.tranp.compatible.cpp.enum#duck_typed': ('rogw.tranp.lang.annotation#duck_typed', 'duck_typed(Any) -> Callable<T, T>'),
		...
		'rogw.tranp.compatible.cpp.enum#CEnum.__eq__.other': ('typing#Union', 'Union<Self, int>'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__or__.self': ('rogw.tranp.compatible.cpp.enum#CEnum', 'CEnum'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__or__.other': ('typing#Self', 'Self'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__ror__.self': ('rogw.tranp.compatible.cpp.enum#CEnum', 'CEnum'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__ror__.other': ('typing#Self', 'Self'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__hash__.self': ('rogw.tranp.compatible.cpp.enum#CEnum', 'CEnum'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__cast_addr__.self': ('rogw.tranp.compatible.cpp.enum#CEnum', 'CEnum'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__cast_addr__.to_origin': ('rogw.tranp.compatible.libralies.type#type', 'type<T>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.C': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.C', 'C(Sub) -> C'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction', 'ForFunction'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction.anno_param': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction.anno_param', 'anno_param(ForFunction, int, bool) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar', 'DeclThisVar'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.__init__': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.__init__', '__init__(DeclThisVar, int) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass', 'ForClass'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ES': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ES', 'ES'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.EN': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.EN', 'EN'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum', 'ForEnum'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props', 'ref_props(ForEnum) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T_Args': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T_Args', 'T_Args'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T_Base': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T_Base', 'T_Base'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1.__init__': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1.__init__', '__init__(G1<T>, T) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2', 'G2<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.__init__': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.__init__', '__init__(G2<T>, G1<T>) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3', 'G3'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref', 'v_ref(G3) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate', 'Delegate<T_Args>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.bind': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.bind', 'bind(Delegate<T_Args>, T, Callable<T, T_Args, None>) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.invoke': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.invoke', 'invoke(Delegate<T_Args>, T_Args) -> None'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.boundary_call': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.boundary_call', 'boundary_call(ForTemplateClass, type<T_Base>) -> T_Base'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda', 'ForLambda'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda.expression': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda.expression', 'expression(ForLambda) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Callable': ('collections.abc#Callable', 'Callable'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Iterator': ('collections.abc#Iterator', 'Iterator<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#os_path': ('os#path', 'path'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Annotated': ('typing#Annotated', 'Annotated'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Base.return_cls.cls': ('rogw.tranp.compatible.libralies.type#type', 'type<Self>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Base.return_cls.base': ('rogw.tranp.compatible.libralies.type#type', 'type<Base>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.C.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub', 'Sub'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.member_ref.sub_cls': ('rogw.tranp.compatible.libralies.type#type', 'type<Sub>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@940.if_clause@941.for@958.i': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@940.if_clause@941.for@958.try@975.catch@993.e': ('rogw.tranp.compatible.libralies.classes#Exception', 'Exception'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@940.if_clause@941.for@958.try@975.try_clause@976.t': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@940.if_clause@941.for@958.try@975.catch@993.t': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@940.if_clause@941.t': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@1048.if_clause@1049.c': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@1048.else_if@1067.c': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@1048.else@1084.c': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.imported_inner_type_ref.a': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db_xyz#B.AA', 'AA=A'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CalcOps.tenary.s_or_null': ('typing#Union', 'Union<str, None>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2354.key0': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2354.value0': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2374.value1': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2392.key1': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2410.key2': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2441.key10': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2441.value10': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#DSI', 'DSI=dict<str, int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2458.value11': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#DSI', 'DSI=dict<str, int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2473.key11': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2488.key12': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.assign.tu': ('typing#Union', 'Union<int, str>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2611.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2643.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2667.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2687.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2734.value': ('rogw.tranp.compatible.libralies.classes#float', 'float'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2774.index': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2774.key': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2823.index': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2823.key': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2861.key': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2861.index': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Nullable.params.base': ('typing#Union', 'Union<Base, None>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Nullable.var_move.base_or_null': ('typing#Union', 'Union<Base, None>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Nullable.accessible.sub': ('typing#Union', 'Union<Sub, None>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Nullable.accessible.subs': ('typing#Union', 'Union<list<Sub>, None>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3691.f': ('typing#IO', 'IO'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3691.content': ('rogw.tranp.compatible.libralies.classes#dict', 'dict<str, Any>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction.anno_param.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction', 'ForFunction'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction.anno_param.an': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForFunction.anno_param.ab': ('rogw.tranp.compatible.libralies.classes#bool', 'bool'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.__init__.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar', 'DeclThisVar'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.__init__.n': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.cls_n': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.anno_dsn': ('rogw.tranp.compatible.libralies.classes#dict', 'dict<str, int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.n': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.sp': ('typing#Union', 'Union<str, None>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.ab': ('rogw.tranp.compatible.libralies.classes#bool', 'bool'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForClass.DeclThisVar.ac': ('typing#Union', 'Union<DeclThisVar, None>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ES.A': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ES.B': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.EN.A': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.EN.B': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum', 'ForEnum'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props.es_a_name': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props.es_a_value': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props.en_b_name': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForEnum.ref_props.en_b_value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1.__init__.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1.__init__.v': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T', 'T'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1.v': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T', 'T'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.__init__.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2', 'G2<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.__init__.v': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2.v': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<T>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3', 'G3'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref.g1': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref.g1_v': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref.g2': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G2', 'G2<int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref.g2_v': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G1', 'G1<int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.G3.v_ref.g3_v': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.bind.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate', 'Delegate<T_Args>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.bind.method': ('collections.abc#Callable', 'Callable<T, T_Args, None>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.invoke.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate', 'Delegate<T_Args>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.Delegate.invoke.args': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T_Args', 'T_Args'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.boundary_call.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass', 'ForTemplateClass'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForTemplateClass.boundary_call.t': ('rogw.tranp.compatible.libralies.type#type', 'type<T_Base>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda.expression.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda', 'ForLambda'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda.expression.f': ('collections.abc#Callable', 'Callable<bool>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda.expression.b': ('rogw.tranp.compatible.libralies.classes#bool', 'bool'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ForLambda.expression.ns': ('rogw.tranp.compatible.libralies.classes#list', 'list<int>'),
