...
class TestNode(TestCase):
	...
	@data_provider([
		...
		('if True: ...', 'file_input.if_stmt', '__main__.if(1)'),
		('for i in [0]: ...', 'file_input.for_stmt', '__main__.for(1)'),
		('while True: ...', 'file_input.while_stmt', '__main__.while(1)'),
	...
	@data_provider([
		...
		('for i in range(1): ...', 'file_input.for_stmt.name', defs.DeclLocalVar, 'i', '__main__.for(1).i'),
		('try:\n\ta\nexcept Exception as e: ...', 'file_input.try_stmt.except_clauses.except_clause.name', defs.DeclLocalVar, 'e', '__main__.try(1).e'),
		...
		('if True:\n\tif True:\n\t\ta.b', 'file_input.if_stmt.block.if_stmt.block.getattr', defs.Relay, 'a.b', '__main__.if(1).if(4).a.b'),
		...
		('if True:\n\ta: int = 0', 'file_input.if_stmt.block.anno_assign.typed_var', defs.GeneralType, 'int', '__main__.if(1).int'),
		...
		# Statement compound
		('if True: ...', 'file_input.if_stmt.block', defs.Block, 'block(3)', '__main__.if(1)'),
		('if True: ...', 'file_input.if_stmt', defs.If, 'if(1)', '__main__.if(1)'),
		# Statement simple
		('a = 0', 'file_input.assign', defs.MoveAssign, 'move_assign(1)', '__main__.move_assign(1)'),
		('a: int = 0', 'file_input.anno_assign', defs.AnnoAssign, 'anno_assign(1)', '__main__.anno_assign(1)'),
		('a += 1', 'file_input.aug_assign', defs.AugAssign, 'aug_assign(1)', '__main__.aug_assign(1)'),
		# Primary
		...
		('a(0)\nfor i in b(): ...', 'file_input.for_stmt.for_in.funccall', defs.FuncCall, 'func_call(13)', '__main__.for(9).func_call(13)'),
	])
...
""",
			...
			[
				...
				'        +-comment: <Proxy: __main__.A.__init__.Empty>',
				'        +-statements:',
				'          +-<AnnoAssign: __main__.A.__init__.anno_assign(32)>',
				...
				'            +-condition: <Truthy: __main__.A.__init__.if(57).bool>',
				'            +-statements:',
				'            | +-<MoveAssign: __main__.A.__init__.if(57).move_assign(60)>',
				'            | | +-receiver: <DeclLocalVar: __main__.A.__init__.if(57).n>',
				'            | | +-value: <Integer: __main__.A.__init__.if(57).int>',
				'            | +-<FuncCall: __main__.A.__init__.if(57).func_call(66)>',
				'            |   +-calls: <Relay: __main__.A.__init__.if(57).a.b>',
				'            |   | +-receiver: <Variable: __main__.A.__init__.if(57).a>',
				'            |   +-arguments:',
				'            |     +-<Argument: __main__.A.__init__.if(57).argument(74)>',
				'            |     | +-label: <Proxy: __main__.A.__init__.if(57).Empty>',
				'            |     | +-value: <Variable: __main__.A.__init__.if(57).c>',
				'            |     +-<Argument: __main__.A.__init__.if(57).argument(78)>',
				'            |       +-label: <Proxy: __main__.A.__init__.if(57).Empty>',
				'            |       +-value: <Variable: __main__.A.__init__.if(57).d>',
				'            +-else_ifs:',
				'            +-else_statements:',
			],
	),])
