...
class SymbolFinder:
	...
	def get_object(self, raws: SymbolRaws) -> Reflection:
		"""objectのシンボルを取得
	...
	def by(self, raws: SymbolRaws, fullyname: str) -> Reflection:
		"""完全参照名からシンボルを取得
	...
	def by_standard(self, raws: SymbolRaws, standard_type: type[Standards] | None) -> Reflection:
		"""標準クラスのシンボルを取得
	...
	def by_symbolic(self, raws: SymbolRaws, node: defs.Symbolic) -> Reflection:
		"""シンボル系ノードからシンボルを取得
	...
	def find_by_symbolic(self, raws: SymbolRaws, node: defs.Symbolic, prop_name: str = '') -> Reflection | None:
	...
	def __find_raw(self, raws: SymbolRaws, scopes: list[str], domain_name: str) -> Reflection | None:
