...
class TestNode(TestCase):
	...
	@data_provider([
		...
		('class A[T1, T2]: ...', 'file_input.class_def.class_def_raw.template_params.template_assign[1]', defs.TemplateClass, 'T2', '__main__#A.T2'),
		...
		('def func(n: Annotated[int, 0]) -> None: ...', 'file_input.function_def.function_def_raw.parameters.paramvalue', defs.Parameter, '', '__main__#func.parameter@8'),
		...
		('def func() -> int:\n\treturn 0', 'file_input.function_def.function_def_raw.block.return_stmt', defs.Return, '', '__main__#func.return@12'),
		('def func() -> Iterator[int]:\n\tyield 0', 'file_input.function_def.function_def_raw.block.yield_stmt', defs.Yield, '', '__main__#func.yield@17'),
		...
		('class B(A): ...', 'file_input.class_def.class_def_raw.inherit_arguments.typed_argvalue', defs.InheritArgument, '', '__main__#B.inherit_argument@8'),  # XXX Typeと同じでは？
		('a(n=0)', 'file_input.funccall.arguments.argvalue.name', defs.ArgumentLabel, '', '__main__#argument_label@7'),
		# Primary - Var
		('class A:\n\ta: ClassVar[int] = 0', 'file_input.class_def.class_def_raw.block.class_var_anno_assign.assign_namelist.var', defs.DeclClassVar, 'a', '__main__#A.a'),
		('class A:\n\ta: ClassVar = 0', 'file_input.class_def.class_def_raw.block.class_var_assign.assign_namelist.var', defs.DeclClassVar, 'a', '__main__#A.a'),
		...
		('class A[T1: int, T2: str]: ...', 'file_input.class_def.class_def_raw.template_params.template_assign[1].template_assign_bound.typed_var', defs.VarOfType, 'str', '__main__#A.T2.str'),
	...
	@data_provider([
		...
		('class A[T1, T2]: ...', 'file_input.class_def.class_def_raw.template_params.template_assign[1]', defs.TemplateClass, '__main__#A', '__main__#A'),
		...
		# Primary - Var
		('class A:\n\ta: ClassVar[int] = 0', 'file_input.class_def.class_def_raw.block.class_var_anno_assign.assign_namelist.var', defs.DeclClassVar, '__main__#A', '__main__#A'),
		('class A:\n\ta: ClassVar = 0', 'file_input.class_def.class_def_raw.block.class_var_assign.assign_namelist.var', defs.DeclClassVar, '__main__#A', '__main__#A'),
		...
		('class A[T1: int, T2: str]: ...', 'file_input.class_def.class_def_raw.template_params.template_assign[1].template_assign_bound.typed_var', defs.VarOfType, '__main__#A.T2', '__main__#A.T2'),
	...
	def test_one_of(self) -> None:
		node = self.fixture.shared_nodes_by('file_input.class_def.class_def_raw.block.function_def[1].function_def_raw.parameters.paramvalue').as_a(defs.Parameter)
		self.assertTrue(node.var_type.one_of(defs.Type, defs.Empty).is_a(defs.Empty))
...
""",
			...
			[
				...
				'    +-statements:',
				'      +-<Constructor: @10 __main__#A.__init__ (3, 2)..(11, 1)>',
				'        +-symbol: <TypesName: @13 __main__#A.__init__.__init__ (3, 6)..(3, 14)>',
				'        +-decorators:',
				'        +-template_params:',
				'        +-parameters:',
				'        | +-<Parameter: @17 __main__#A.__init__.parameter@17 (3, 15)..(3, 19)>',
				'        | | +-symbol: <DeclThisParam: @19 __main__#A.__init__.self (3, 15)..(3, 19)>',
				'        | | +-var_type: <Proxy: @-1 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        | | +-default_value: <Empty: @21 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        | +-<Parameter: @22 __main__#A.__init__.parameter@22 (3, 21)..(3, 27)>',
				'        |   +-symbol: <DeclParam: @24 __main__#A.__init__.n (3, 21)..(3, 22)>',
				'        |   +-var_type: <VarOfType: @26 __main__#A.__init__.int (3, 24)..(3, 27)>',
				'        |   +-default_value: <Empty: @29 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        +-return_type: <NullType: @32 __main__#A.__init__.None (3, 32)..(3, 36)>',
				'        +-comment: <Proxy: @11 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        +-statements:',
				'          +-<AnnoAssign: @34 __main__#A.__init__.anno_assign@34 (4, 3)..(4, 38)>',
				'          | +-receiver: <DeclThisVar: @36 __main__#A.n (4, 3)..(4, 9)>',
				'          | +-var_type: <DictType: @42 __main__#A.__init__.dict (4, 11)..(4, 25)>',
				'          | | +-type_name: <VarOfType: @43 __main__#A.__init__.dict (4, 11)..(4, 15)>',
				'          | | +-key_type: <VarOfType: @47 __main__#A.__init__.str (4, 16)..(4, 19)>',
				'          | | +-value_type: <VarOfType: @50 __main__#A.__init__.int (4, 21)..(4, 24)>',
				'          | +-value: <Dict: @53 __main__#A.__init__.dict@53 (4, 28)..(4, 38)>',
				'          |   +-items:',
				'          |     +-<Pair: @54 __main__#A.__init__.Pair@54 (4, 29)..(4, 37)>',
				'          |       +-first: <String: @55 __main__#A.__init__.str@55 (4, 29)..(4, 34)>',
				'          |       +-second: <Var: @57 __main__#A.__init__.n (4, 36)..(4, 37)>',
				'          +-<If: @60 __main__#A.__init__.if@60 (5, 3)..(8, 3)>',
				'          | +-condition: <Truthy: @62 __main__#A.__init__.if@60.if_clause@61.bool@62 (5, 6)..(5, 10)>',
				'          | +-statements:',
				'          | | +-<MoveAssign: @64 __main__#A.__init__.if@60.if_clause@61.move_assign@64 (6, 4)..(6, 9)>',
				'          | | | +-receivers:',
				'          | | | | +-<DeclLocalVar: @66 __main__#A.__init__.if@60.if_clause@61.n (6, 4)..(6, 5)>',
				'          | | | +-value: <Integer: @69 __main__#A.__init__.if@60.if_clause@61.int@69 (6, 8)..(6, 9)>',
				'          | | +-<FuncCall: @71 __main__#A.__init__.if@60.if_clause@61.func_call@71 (7, 4)..(7, 13)>',
				'          | |   +-calls: <Relay: @72 __main__#A.__init__.if@60.if_clause@61.a.b (7, 4)..(7, 7)>',
				'          | |   | +-receiver: <Var: @73 __main__#A.__init__.if@60.if_clause@61.a (7, 4)..(7, 5)>',
				'          | |   +-arguments:',
				'          | |     +-<Argument: @79 __main__#A.__init__.if@60.if_clause@61.argument@79 (7, 8)..(7, 9)>',
				'          | |     | +-label: <Proxy: @-1 __main__#A.__init__.if@60.if_clause@61.Empty (0, 0)..(0, 0)>',
				'          | |     | +-value: <Var: @80 __main__#A.__init__.if@60.if_clause@61.c (7, 8)..(7, 9)>',
				'          | |     +-<Argument: @83 __main__#A.__init__.if@60.if_clause@61.argument@83 (7, 11)..(7, 12)>',
				'          | |       +-label: <Proxy: @-1 __main__#A.__init__.if@60.if_clause@61.Empty (0, 0)..(0, 0)>',
				'          | |       +-value: <Var: @84 __main__#A.__init__.if@60.if_clause@61.d (7, 11)..(7, 12)>',
				'          | +-else_ifs:',
				'          | +-else_clause: <Empty: @90 __main__#A.__init__.if@60.Empty (0, 0)..(0, 0)>',
				'          +-<For: @91 __main__#A.__init__.for@91 (8, 3)..(11, 1)>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: @93 __main__#A.__init__.for@91.key (8, 7)..(8, 10)>',
				'            | +-<DeclLocalVar: @95 __main__#A.__init__.for@91.value (8, 12)..(8, 17)>',
				'            +-for_in: <ForIn: @97 __main__#A.__init__.for@91.for_in@97 (8, 18)..(8, 37)>',
				'            | +-iterates: <FuncCall: @98 __main__#A.__init__.for@91.func_call@98 (8, 21)..(8, 37)>',
				'            |   +-calls: <Relay: @99 __main__#A.__init__.for@91.dict@100.items (8, 21)..(8, 35)>',
				'            |   | +-receiver: <Dict: @100 __main__#A.__init__.for@91.dict@100 (8, 21)..(8, 29)>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: @101 __main__#A.__init__.for@91.Pair@101 (8, 22)..(8, 28)>',
				'            |   |       +-first: <String: @102 __main__#A.__init__.for@91.str@102 (8, 22)..(8, 25)>',
				'            |   |       +-second: <Integer: @104 __main__#A.__init__.for@91.int@104 (8, 27)..(8, 28)>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: @110 __main__#A.__init__.for@91.elipsis@110 (9, 4)..(9, 7)>',
			],
	),])
