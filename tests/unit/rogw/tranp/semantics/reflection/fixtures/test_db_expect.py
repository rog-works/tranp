def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'rogw.tranp.compatible.libralies.classes#object.mro': ('rogw.tranp.compatible.libralies.classes#object.mro', 'mro(object) -> list<type<T>>'),
		...
		'rogw.tranp.compatible.libralies.classes#type.__eq__': ('rogw.tranp.compatible.libralies.classes#type.__eq__', '__eq__(type<T>, type<T>) -> bool'),
		'rogw.tranp.compatible.libralies.classes#type.__not__': ('rogw.tranp.compatible.libralies.classes#type.__not__', '__not__(type<T>, type<T>) -> bool'),
		...
		'rogw.tranp.compatible.libralies.classes#isinstance': ('rogw.tranp.compatible.libralies.classes#isinstance', 'isinstance(object, Union<type<T>, tuple>) -> bool'),
		'rogw.tranp.compatible.libralies.classes#issubclass': ('rogw.tranp.compatible.libralies.classes#issubclass', 'issubclass(type<T>, Union<type<T>, tuple>) -> bool'),
		...
		'rogw.tranp.compatible.libralies.classes#type.__eq__.other': ('rogw.tranp.compatible.libralies.classes#type', 'type<T>'),
		'rogw.tranp.compatible.libralies.classes#type.__not__.self': ('rogw.tranp.compatible.libralies.classes#type', 'type<T>'),
		'rogw.tranp.compatible.libralies.classes#type.__not__.other': ('rogw.tranp.compatible.libralies.classes#type', 'type<T>'),
		...
		'rogw.tranp.compatible.libralies.classes#isinstance.class_or_tuple': ('rogw.tranp.compatible.libralies.classes#Union', 'Union<type<T>, tuple>'),
		'rogw.tranp.compatible.libralies.classes#issubclass._type': ('rogw.tranp.compatible.libralies.classes#type', 'type<T>'),
		'rogw.tranp.compatible.libralies.classes#issubclass.class_or_tuple': ('rogw.tranp.compatible.libralies.classes#Union', 'Union<type<T>, tuple>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.member_ref.sub_t': ('rogw.tranp.compatible.libralies.classes#type', 'type<Sub>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@897.if_clause@898.for@915.i': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@897.if_clause@898.for@915.try@932.catch@950.e': ('rogw.tranp.compatible.libralies.classes#Exception', 'Exception'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@897.if_clause@898.for@915.try@932.try_clause@933.t': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@897.if_clause@898.for@915.try@932.catch@950.t': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@897.if_clause@898.t': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@1005.if_clause@1006.c': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@1005.else_if@1024.c': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Sub.decl_locals.if@1005.else@1041.c': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2329.key0': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2329.value0': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2349.value1': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2367.key1': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2385.key2': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2416.key10': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2416.value10': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#DSI', 'DSI=dict<str, int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2433.value11': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#DSI', 'DSI=dict<str, int>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2448.key11': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#TupleOps.unpack.for@2463.key12': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2588.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2620.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2644.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2664.value': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.list_comp.list_comp@2711.value': ('rogw.tranp.compatible.libralies.classes#float', 'float'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2752.index': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2752.key': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2801.index': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2801.key': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2839.key': ('rogw.tranp.compatible.libralies.classes#str', 'str'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#CompOps.dict_comp.dict_comp@2839.index': ('rogw.tranp.compatible.libralies.classes#int', 'int'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3682.f': ('typing#IO', 'IO'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3682.content': ('rogw.tranp.compatible.libralies.classes#dict', 'dict<str, Any>'),
