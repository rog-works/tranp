...
class TestNode(TestCase):
	...
	@data_provider([
		...
		('for i in range(1): ...', 'file_input.for_stmt.name', defs.LocalDeclVar, 'i', '__main__.i'),
		('try:\n\ta\nexcept Exception as e: ...', 'file_input.try_stmt.except_clauses.except_clause.name', defs.LocalDeclVar, 'e', '__main__.e'),
