...
""",
			...
			[
				...
				'          +-<For: __main__#A.__init__.for@89 (8, 3)..(11, 1)>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: __main__#A.__init__.for@89.key (8, 7)..(8, 10)>',
				'            | +-<DeclLocalVar: __main__#A.__init__.for@89.value (8, 12)..(8, 17)>',
				'            +-for_in: <ForIn: __main__#A.__init__.for@89.for_in@95 (8, 18)..(8, 37)>',
				'            | +-iterates: <FuncCall: __main__#A.__init__.for@89.func_call@96 (8, 21)..(8, 37)>',
				'            |   +-calls: <Relay: __main__#A.__init__.for@89.dict@98.items (8, 21)..(8, 35)>',
				'            |   | +-receiver: <Dict: __main__#A.__init__.for@89.dict@98 (8, 21)..(8, 29)>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: __main__#A.__init__.for@89.Pair@99 (8, 22)..(8, 28)>',
				'            |   |       +-first: <String: __main__#A.__init__.for@89.str@100 (8, 22)..(8, 25)>',
				'            |   |       +-second: <Integer: __main__#A.__init__.for@89.int@102 (8, 27)..(8, 28)>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: __main__#A.__init__.for@89.elipsis@108 (9, 4)..(9, 7)>',
			],
	),])
