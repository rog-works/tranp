def expected_symbols() -> dict:
	return {
		...
		'__main__.Comp.dict_comp.dict_comp@1261.index': 'rogw.tranp.compatible.python.classes.int',
		'__main__.Comp.dict_comp.dict_comp@1261.key': 'rogw.tranp.compatible.python.classes.str',
