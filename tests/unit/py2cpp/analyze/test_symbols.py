...
def _ast(before: str, after: str) -> str:
	aliases = {
		'__main__': 'file_input',
		'A': 'file_input.class_def[3]',
		'A.__init__.params': 'file_input.class_def[3].class_def_raw.block.function_def.function_def_raw.parameters',
		'A.__init__.return': 'file_input.class_def[3].class_def_raw.block.function_def.function_def_raw.return_type',
		'A.__init__.block': 'file_input.class_def[3].class_def_raw.block.function_def.function_def_raw.block',
		'B': 'file_input.class_def[4]',
		'B.B2': 'file_input.class_def[4].class_def_raw.block.class_def',
		'B.B2.block': 'file_input.class_def[4].class_def_raw.block.class_def.class_def_raw.block',
		'B.B2.class_func': 'file_input.class_def[4].class_def_raw.block.class_def.class_def_raw.block.function_def',
		'B.B2.class_func.params': 'file_input.class_def[4].class_def_raw.block.class_def.class_def_raw.block.function_def.function_def_raw.parameters',
		'B.B2.class_func.return': 'file_input.class_def[4].class_def_raw.block.class_def.class_def_raw.block.function_def.function_def_raw.return_type',
		'B.B2.class_func.block': 'file_input.class_def[4].class_def_raw.block.class_def.class_def_raw.block.function_def.function_def_raw.block',
		'B.__init__.params': 'file_input.class_def[4].class_def_raw.block.function_def[1].function_def_raw.parameters',
		'B.__init__.return': 'file_input.class_def[4].class_def_raw.block.function_def[1].function_def_raw.return_type',
		'B.__init__.block': 'file_input.class_def[4].class_def_raw.block.function_def[1].function_def_raw.block',
		'B.func1.params': 'file_input.class_def[4].class_def_raw.block.function_def[2].function_def_raw.parameters',
		'B.func1.return': 'file_input.class_def[4].class_def_raw.block.function_def[2].function_def_raw.return_type',
		'B.func1.block': 'file_input.class_def[4].class_def_raw.block.function_def[2].function_def_raw.block',
		'B.func2.block': 'file_input.class_def[4].class_def_raw.block.function_def[3].function_def_raw.block',
		'B.func2.closure.block': 'file_input.class_def[4].class_def_raw.block.function_def[3].function_def_raw.block.function_def.function_def_raw.block',
	}
