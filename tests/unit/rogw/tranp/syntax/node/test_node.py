...
class TestNode(TestCase):
	...
	@data_provider([
		...
		('assert ok, ValueError', 'file_input.assert_stmt', defs.Assert, '', '__main__#assert@1'),
	...
	@data_provider([
		...
		('assert ok, ValueError', 'file_input.assert_stmt', defs.Assert, '__main__', '__main__'),
...
""",
			...
			[
				...
				'        | | +-default_value: <Empty: @18 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        | +-<Parameter: @19 __main__#A.__init__.parameter@19 (3, 21)..(3, 27)>',
				'        |   +-symbol: <DeclParam: @21 __main__#A.__init__.n (3, 21)..(3, 22)>',
				'        |   +-var_type: <VarOfType: @23 __main__#A.__init__.int (3, 24)..(3, 27)>',
				'        |   +-default_value: <Empty: @26 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        +-return_type: <NullType: @29 __main__#A.__init__.None (3, 32)..(3, 36)>',
				'        +-comment: <Proxy: @9 __main__#A.__init__.Empty (0, 0)..(0, 0)>',
				'        +-statements:',
				'          +-<AnnoAssign: @31 __main__#A.__init__.anno_assign@31 (4, 3)..(4, 38)>',
				'          | +-receiver: <DeclThisVar: @33 __main__#A.n (4, 3)..(4, 9)>',
				'          | +-var_type: <DictType: @39 __main__#A.__init__.dict (4, 11)..(4, 25)>',
				'          | | +-type_name: <VarOfType: @40 __main__#A.__init__.dict (4, 11)..(4, 15)>',
				'          | | +-key_type: <VarOfType: @44 __main__#A.__init__.str (4, 16)..(4, 19)>',
				'          | | +-value_type: <VarOfType: @47 __main__#A.__init__.int (4, 21)..(4, 24)>',
				'          | +-value: <Dict: @50 __main__#A.__init__.dict@50 (4, 28)..(4, 38)>',
				'          |   +-items:',
				'          |     +-<Pair: @51 __main__#A.__init__.Pair@51 (4, 29)..(4, 37)>',
				'          |       +-first: <String: @52 __main__#A.__init__.str@52 (4, 29)..(4, 34)>',
				'          |       +-second: <Var: @54 __main__#A.__init__.n (4, 36)..(4, 37)>',
				'          +-<If: @57 __main__#A.__init__.if@57 (5, 3)..(8, 3)>',
				'          | +-condition: <Truthy: @59 __main__#A.__init__.if@57.if_clause@58.bool@59 (5, 6)..(5, 10)>',
				'          | +-statements:',
				'          | | +-<MoveAssign: @61 __main__#A.__init__.if@57.if_clause@58.move_assign@61 (6, 4)..(6, 9)>',
				'          | | | +-receivers:',
				'          | | | | +-<DeclLocalVar: @63 __main__#A.__init__.if@57.if_clause@58.n (6, 4)..(6, 5)>',
				'          | | | +-value: <Integer: @66 __main__#A.__init__.if@57.if_clause@58.int@66 (6, 8)..(6, 9)>',
				'          | | +-<FuncCall: @68 __main__#A.__init__.if@57.if_clause@58.func_call@68 (7, 4)..(7, 13)>',
				'          | |   +-calls: <Relay: @69 __main__#A.__init__.if@57.if_clause@58.a.b (7, 4)..(7, 7)>',
				'          | |   | +-receiver: <Var: @70 __main__#A.__init__.if@57.if_clause@58.a (7, 4)..(7, 5)>',
				'          | |   +-arguments:',
				'          | |     +-<Argument: @76 __main__#A.__init__.if@57.if_clause@58.argument@76 (7, 8)..(7, 9)>',
				'          | |     | +-label: <Proxy: @-1 __main__#A.__init__.if@57.if_clause@58.Empty (0, 0)..(0, 0)>',
				'          | |     | +-value: <Var: @77 __main__#A.__init__.if@57.if_clause@58.c (7, 8)..(7, 9)>',
				'          | |     +-<Argument: @80 __main__#A.__init__.if@57.if_clause@58.argument@80 (7, 11)..(7, 12)>',
				'          | |       +-label: <Proxy: @-1 __main__#A.__init__.if@57.if_clause@58.Empty (0, 0)..(0, 0)>',
				'          | |       +-value: <Var: @81 __main__#A.__init__.if@57.if_clause@58.d (7, 11)..(7, 12)>',
				'          | +-else_ifs:',
				'          | +-else_clause: <Empty: @87 __main__#A.__init__.if@57.Empty (0, 0)..(0, 0)>',
				'          +-<For: @88 __main__#A.__init__.for@88 (8, 3)..(11, 1)>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: @90 __main__#A.__init__.for@88.key (8, 7)..(8, 10)>',
				'            | +-<DeclLocalVar: @92 __main__#A.__init__.for@88.value (8, 12)..(8, 17)>',
				'            +-for_in: <ForIn: @94 __main__#A.__init__.for@88.for_in@94 (8, 18)..(8, 37)>',
				'            | +-iterates: <FuncCall: @95 __main__#A.__init__.for@88.func_call@95 (8, 21)..(8, 37)>',
				'            |   +-calls: <Relay: @96 __main__#A.__init__.for@88.dict@97.items (8, 21)..(8, 35)>',
				'            |   | +-receiver: <Dict: @97 __main__#A.__init__.for@88.dict@97 (8, 21)..(8, 29)>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: @98 __main__#A.__init__.for@88.Pair@98 (8, 22)..(8, 28)>',
				'            |   |       +-first: <String: @99 __main__#A.__init__.for@88.str@99 (8, 22)..(8, 25)>',
				'            |   |       +-second: <Integer: @101 __main__#A.__init__.for@88.int@101 (8, 27)..(8, 28)>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: @107 __main__#A.__init__.for@88.elipsis@107 (9, 4)..(9, 7)>',
			],
	),])
