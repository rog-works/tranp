...
from rogw.tranp.compatible.cpp.object import CP, CPConst, CRef, CSP, CRefConst
...
class CVarOps:
	...
	def const_move(self, a: Base, ap: CP[Base], r: CRef[Base]) -> None:
		ap_const = CPConst(a)
		r_const = CRefConst(a)
		ap_const2 = r_const.addr
		r_const2 = ap_const2.ref
