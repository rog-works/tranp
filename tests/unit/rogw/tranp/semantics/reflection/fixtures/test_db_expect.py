def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3731.f': ('typing#IO', 'IO'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3731.content': ('rogw.tranp.compatible.libralies.classes#dict', 'dict<str, Any>'),
