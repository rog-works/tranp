...
class TestRenderer(TestCase):
	...
	@data_provider([
		({'module_path': 'module.path.to', 'before_dir': '', 'replace_dir': ''}, '// #include "module/path/to.h"'),
		({'module_path': 'module.path.to', 'before_dir': 'module/path/', 'replace_dir': 'path/'}, '#include "path/to.h"'),
	])
