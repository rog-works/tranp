...
class TestSymbolDB(TestCase):
	...
	@data_provider([
		({
			...
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list',
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__init__': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__init__',
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__iter__': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__iter__',
			...
			# 標準ライブラリー(Declable)
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__init__.self': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list',
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__init__.iterable': 'typing.Iterator',
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.__iter__.self': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list',
			'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.append': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list.append',
			...
			'typing.Pair': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			...
			'py2cpp.compatible.python.template.Pair': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			...
			'py2cpp.compatible.python.embed.Pair': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			...
			'tests.unit.py2cpp.analize.fixtures.test_db_xyz.Pair': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			...
			'__main__.Pair': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			...
			# '__main__.B.B2.str@91': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.str',
			# '__main__.B.B2.class_func.Pair@126': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Pair',
			# '__main__.B.B2.class_func.dict@125': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.dict',
			# '__main__.B.__init__.super@154': '__main__.A',
			# '__main__.B.__init__.func_call@152': '__main__.A',
			# '__main__.B.__init__.list@177': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.list',
			# '__main__.B.func1.bool@213': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.bool',
			# '__main__.B.func1.func_call@214': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.None',
			# '__main__.B.func1.func_call@223': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.None',
			# '__main__.B.func1.int@247': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func1.func_call@235': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.None',
			# '__main__.B.func1.str@261': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.str',
			# '__main__.B.func1.int@273': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func2.closure.int@323': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func2.for.int@339': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func2.for.func_call@333': 'typing.Iterator',
			# '__main__.B.func2.for.func_call@342': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.None',
			# '__main__.B.func2.for.if.int@358': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func2.for.if.func_call@362': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func2.try.while.bool@372': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.bool',
			# '__main__.B.func2.try.while.if.int@381': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# '__main__.B.func2.func_call@401': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
		},),
	])
