def expected_symbols() -> dict:
	return {
		...
		'__main__.Comp.list_comp.values': 'rogw.tranp.compatible.python.classes.list',
		'__main__.Comp.dict_comp.index': 'rogw.tranp.compatible.python.classes.int',
		'__main__.Comp.dict_comp.key': 'rogw.tranp.compatible.python.classes.str',
		'__main__.Comp.dict_comp.self': '__main__.Comp',
		'__main__.Comp.dict_comp.kvs': 'rogw.tranp.compatible.python.classes.dict',
