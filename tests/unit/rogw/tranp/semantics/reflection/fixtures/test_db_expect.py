def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'rogw.tranp.compatible.cpp.enum#CEnum.__ne__': ('rogw.tranp.compatible.cpp.enum#CEnum.__ne__', '__ne__(CEnum, Union<Self, int>) -> bool'),
		...
		'rogw.tranp.compatible.cpp.enum#CEnum.__ne__.self': ('rogw.tranp.compatible.cpp.enum#CEnum', 'CEnum'),
		'rogw.tranp.compatible.cpp.enum#CEnum.__ne__.other': ('typing#Union', 'Union<Self, int>'),
