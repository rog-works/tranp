...
class ForCompound:
	...
	class Operators:
		# comparison
		@Embed.param('other', mutable=False)
		def __eq__(self, other: 'ForCompound.Operators') -> bool: ...
		@Embed.param('other', mutable=False)
		def __ne__(self, other: 'ForCompound.Operators') -> bool: ...
		@Embed.param('other', mutable=False)
		def __lt__(self, other: 'ForCompound.Operators') -> bool: ...
		@Embed.param('other', mutable=False)
		def __gt__(self, other: 'ForCompound.Operators') -> bool: ...
		@Embed.param('other', mutable=False)
		def __le__(self, other: 'ForCompound.Operators') -> bool: ...
		@Embed.param('other', mutable=False)
		def __ge__(self, other: 'ForCompound.Operators') -> bool: ...
		# arithmetic
		@Embed.param('value', mutable=False)
	...
	class Modifier:
		...
		@Embed.pure
		def pure(self) -> None: ...
		@Embed.param('s_m', mutable=True)
		def mod_mutable(self, s_m: str, s_i: str, ns_i: list[int], dsn_i: dict[str, int], func_i: Callable[[], None]) -> None: ...
