...
class TestSymbolDB(TestCase):
	...
	@data_provider([
		({
			...
			'__main__.B.func1.v': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'__main__.B.func2.self': '__main__.B',
			'__main__.B.func2.for.i': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'__main__.B.func2.try.e': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'__main__.B.func2.closure.a': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
