...
class TestSymbolDB(TestCase):
	...
	@data_provider([
		({
			...
			'typing.int': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.int',
			'typing.float': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.float',
			'typing.str': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.str',
			'typing.bool': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.bool',
			'typing.tuple': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.tuple',
			'typing.Pair': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Pair',
			'typing.list': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.list',
			'typing.dict': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.dict',
			'typing.None': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.None',
			'typing.Union': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Union',
			'typing.Unknown': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'typing.type': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.type',
			'typing.super': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.super',
			'typing.Exception': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'typing.id': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.id',
			'typing.print': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.print',
			'typing.enumerate': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.enumerate',
			'typing.range': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.range',
			'typing.len': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.len',
			...
			'py2cpp.compatible.python.template.int': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.int',
			'py2cpp.compatible.python.template.float': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.float',
			'py2cpp.compatible.python.template.str': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.str',
			'py2cpp.compatible.python.template.bool': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.bool',
			'py2cpp.compatible.python.template.tuple': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.tuple',
			'py2cpp.compatible.python.template.Pair': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Pair',
			'py2cpp.compatible.python.template.list': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.list',
			'py2cpp.compatible.python.template.dict': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.dict',
			'py2cpp.compatible.python.template.None': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.None',
			'py2cpp.compatible.python.template.Union': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Union',
			'py2cpp.compatible.python.template.Unknown': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'py2cpp.compatible.python.template.type': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.type',
			'py2cpp.compatible.python.template.super': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.super',
			'py2cpp.compatible.python.template.Exception': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'py2cpp.compatible.python.template.id': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.id',
			'py2cpp.compatible.python.template.print': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.print',
			'py2cpp.compatible.python.template.enumerate': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.enumerate',
			'py2cpp.compatible.python.template.range': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.range',
			'py2cpp.compatible.python.template.len': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.len',
			...
			'py2cpp.compatible.python.embed.int': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.int',
			'py2cpp.compatible.python.embed.float': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.float',
			'py2cpp.compatible.python.embed.str': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.str',
			'py2cpp.compatible.python.embed.bool': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.bool',
			'py2cpp.compatible.python.embed.tuple': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.tuple',
			'py2cpp.compatible.python.embed.Pair': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Pair',
			'py2cpp.compatible.python.embed.list': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.list',
			'py2cpp.compatible.python.embed.dict': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.dict',
			'py2cpp.compatible.python.embed.None': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.None',
			'py2cpp.compatible.python.embed.Union': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Union',
			'py2cpp.compatible.python.embed.Unknown': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'py2cpp.compatible.python.embed.type': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.type',
			'py2cpp.compatible.python.embed.super': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.super',
			'py2cpp.compatible.python.embed.Exception': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'py2cpp.compatible.python.embed.id': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.id',
			'py2cpp.compatible.python.embed.print': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.print',
			'py2cpp.compatible.python.embed.enumerate': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.enumerate',
			'py2cpp.compatible.python.embed.range': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.range',
			'py2cpp.compatible.python.embed.len': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.len',
			...
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.int': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.int',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.float': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.float',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.str': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.str',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.bool': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.bool',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.tuple': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.tuple',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.Pair': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Pair',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.list': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.list',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.dict': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.dict',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.None': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.None',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.Union': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Union',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.Unknown': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.type': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.type',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.super': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.super',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.Exception': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.id': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.id',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.print': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.print',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.enumerate': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.enumerate',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.range': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.range',
			'tests.unit.py2cpp.analyze.fixtures.test_db_xyz.len': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.len',
			...
			'__main__.int': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.int',
			'__main__.float': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.float',
			'__main__.str': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.str',
			'__main__.bool': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.bool',
			'__main__.tuple': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.tuple',
			'__main__.Pair': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Pair',
			'__main__.list': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.list',
			'__main__.dict': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.dict',
			'__main__.None': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.None',
			'__main__.Union': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Union',
			'__main__.Unknown': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',
			'__main__.type': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.type',
			'__main__.super': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.super',
			'__main__.Exception': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'__main__.id': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.id',
			'__main__.print': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.print',
			'__main__.enumerate': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.enumerate',
			'__main__.range': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.range',
			'__main__.len': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.len',
			...
			'__main__.B.func1.v': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',  # FIXME 追って修正
			'__main__.B.func2.self': '__main__.B',
			'__main__.B.func2.for.i': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',  # FIXME 追って修正
			'__main__.B.func2.try.e': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Exception',
			'__main__.B.func2.closure.a': 'tests.unit.py2cpp.analyze.fixtures.test_db_classes.Unknown',  # FIXME 追って修正
