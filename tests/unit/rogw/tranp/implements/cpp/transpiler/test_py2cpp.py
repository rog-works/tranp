...
class TestPy2Cpp(TestCase):
	...
	@data_provider([
		...
		('CVarOps.binary_calc', 'function_def_raw.block.assign[4]', defs.MoveAssign, 'float mod = fmod(1.0f, 1);'),
		...
		('CVarOps.alt_csp', 'function_def_raw.block.assign[0]', defs.MoveAssign, 'AltCSP<Sub> alt_sp = std::make_shared<Sub>(0);'),  # XXX CSPと同様の変換を行うにはテンプレートの対応が必要
		...
		('ForEnum.literalize', 'function_def_raw.block.funccall[0]', defs.FuncCall, 'printf("AS");'),
		('ForEnum.literalize', 'function_def_raw.block.funccall[1]', defs.FuncCall, 'printf("BS");'),
		('ForEnum.literalize', 'function_def_raw.block.funccall[2]', defs.FuncCall, 'printf("a");'),
		('ForEnum.literalize', 'function_def_raw.block.funccall[3]', defs.FuncCall, 'printf("b");'),
		('ForEnum.literalize', 'function_def_raw.block.funccall[4]', defs.FuncCall, 'printf("AN");'),
		('ForEnum.literalize', 'function_def_raw.block.funccall[5]', defs.FuncCall, 'printf("BN");'),
		...
		('ForFunction.Method.numbers', '', defs.Method, BlockExpects.ForIteratorList2),
		...
		('ForFunction.Operators.__lt__', '', defs.Method, BlockExpects.method(access='public', name='operator<', params=['const ForFunction::Operators& other'], return_type='bool')),
		('ForFunction.Operators.__gt__', '', defs.Method, BlockExpects.method(access='public', name='operator>', params=['const ForFunction::Operators& other'], return_type='bool')),
		('ForFunction.Operators.__le__', '', defs.Method, BlockExpects.method(access='public', name='operator<=', params=['const ForFunction::Operators& other'], return_type='bool')),
		('ForFunction.Operators.__ge__', '', defs.Method, BlockExpects.method(access='public', name='operator>=', params=['const ForFunction::Operators& other'], return_type='bool')),
		('ForFunction.Operators.__add__', '', defs.Method, BlockExpects.method(access='public', name='operator+', params=['const int& value'], return_type='int')),
		('ForFunction.Operators.__sub__', '', defs.Method, BlockExpects.method(access='public', name='operator-', params=['const int& value'], return_type='int')),
		('ForFunction.Operators.__mul__', '', defs.Method, BlockExpects.method(access='public', name='operator*', params=['const int& value'], return_type='int')),
		('ForFunction.Operators.__mod__', '', defs.Method, BlockExpects.method(access='public', name='operator%', params=['const int& value'], return_type='int')),
		('ForFunction.Operators.__truediv__', '', defs.Method, BlockExpects.method(access='public', name='operator/', params=['const int& value'], return_type='int')),
		('ForFunction.Operators.__and__', '', defs.Method, BlockExpects.method(access='public', name='operator&', params=['const int& value'], return_type='int')),
		('ForFunction.Operators.__or__', '', defs.Method, BlockExpects.method(access='public', name='operator|', params=['const int& value'], return_type='int')),
		...
		('ForFlows.if_isinstance', 'function_def_raw.block.if_stmt', defs.If, BlockExpects.ForFlows_if_isinstance),
		('ForFlows.if_issubclass', 'function_def_raw.block.if_stmt', defs.If, BlockExpects.ForFlows_if_issubclass),
		...
		('ForType.literal_type', 'function_def_raw.block.anno_assign[0]', defs.AnnoAssign, 'int n01 = 0;'),
		...
		('ForFuncCall.Func.print', 'function_def_raw.block.funccall', defs.FuncCall, 'printf("message. %d, %f, %s", 1, 1.0f, "abc");'),
		...
		('ForFuncCall.Cast.cast_binary', 'function_def_raw.block.assign[0]', defs.MoveAssign, 'int f_to_n = (int(1.0f));'),
		...
		('ForFuncCall.Cast.cast_string', 'function_def_raw.block.assign[1]', defs.MoveAssign, 'std::string f_to_s = std::to_string(1.0f);'),
		...
		('ForFuncCall.String.format', 'function_def_raw.block.funccall[0]', defs.FuncCall, 'std::format("%d, %f, %d, %s, %s, %p, %d", 1, 2.0f, true, "3", (s).c_str(), (this), Values::A);'),
		...
		('ForFuncCall.Generic.call_t1', 'function_def_raw.block.funccall', defs.FuncCall, 'this->call_t1<int>();'),
		('ForFuncCall.Generic.call_t1a1', 'function_def_raw.block.funccall', defs.FuncCall, 'this->call_t1a1<int>(1);'),
		('ForFuncCall.Generic.call_t1t2', 'function_def_raw.block.funccall', defs.FuncCall, 'this->call_t1t2<int, float>();'),
		('ForFuncCall.Generic.call_t1t2a1', 'function_def_raw.block.funccall', defs.FuncCall, 'this->call_t1t2a1<int, float>(1);'),
		...
		('ForBinaryOperator.decimal_mod', 'function_def_raw.block.funccall', defs.FuncCall, "printf(fmod((fmod(1.0f, 1)), (fmod(1, 1.0f))));"),
		...
		('ForBinaryOperator.ops', 'function_def_raw.block.assign[1]', defs.MoveAssign, 'double add = 0 + b + ui32 + ui64 + d;'),
		('ForBinaryOperator.ops', 'function_def_raw.block.assign[7]', defs.MoveAssign, 'bool eq = 0 == b == ui32 == ui64 == d;'),
		('ForBinaryOperator.ops', 'function_def_raw.block.assign[12]', defs.MoveAssign, 'byte shift_b = b << 1;'),
		('ForBinaryOperator.op_to_assign', 'function_def_raw.block.assign[1]', defs.MoveAssign, 'std::string s = c + std::string("");'),
		('ForBinaryOperator.op_to_assign', 'function_def_raw.block.assign[2]', defs.MoveAssign, 'uint64 i = ui64 * 0;'),
		('ForBinaryOperator.op_to_assign', 'function_def_raw.block.assign[3]', defs.MoveAssign, 'double f = d * 0.0f;'),
		...
		# FIXME パラメーターの型を無理やり変更する影響で型が食い違ってしまう
		('ForLambda.params', 'function_def_raw.block.anno_assign', defs.AnnoAssign, 'std::function<int(std::string)> func = [](const std::string& s) -> int { return 1; };'),
