...
@__actual__('int')
class Integer:
	def __init__(self: Self, value: Self | int | float | bool) -> None: ...
	# comparison
	def __eq__(self: Self, other: Self | int | float | bool) -> bool: ...
	def __ne__(self: Self, other: Self | int | float | bool) -> bool: ...
	def __lt__(self: Self, other: Self | int | float | bool) -> bool: ...
	def __gt__(self: Self, other: Self | int | float | bool) -> bool: ...
	def __le__(self: Self, other: Self | int | float | bool) -> bool: ...
	def __ge__(self: Self, other: Self | int | float | bool) -> bool: ...
	# FIXME other: Any
	def __not__(self: Self, other: Self | int | float | bool | str) -> bool: ...
	# arithmetic
	def __add__(self: Self, other: Self | int | bool) -> Self: ...
	def __sub__(self: Self, other: Self | int | bool) -> Self: ...
	def __mul__(self: Self, other: Self | int | bool) -> Self: ...
	def __truediv__(self: Self, other: Self | int | bool) -> float: ...
	def __mod__(self: Self, other: Self | int | bool) -> Self: ...
	# bitwise
	def __and__(self: Self, other: Self | int | bool) -> Self: ...
	def __or__(self: Self, other: Self | int | bool) -> Self: ...
	def __xor__(self: Self, other: Self | int | bool) -> Self: ...
	def __lshift__(self: Self, shift: Self | int) -> Self: ...
	def __rshift__(self: Self, shift: Self | int) -> Self: ...
	# conversion
...
class Float:
	...
	def __not__(self: Self, other: Self | int | float | bool | str) -> bool: ...
	# arithmetic
	def __add__(self: Self, other: Self | int | float | bool) -> Self: ...
	def __sub__(self: Self, other: Self | int | float | bool) -> Self: ...
	def __mul__(self: Self, other: Self | int | float | bool) -> Self: ...
	def __truediv__(self: Self, other: Self | int | float | bool) -> Self: ...
	def __mod__(self: Self, other: Self | int | float) -> Self: ...
	# conversion
	def __int__(self) -> int: ...
	def __float__(self) -> float: ...
	def __str__(self) -> str: ...
...
@__actual__('list')
class List[T_Value](Sequence[T_Value]):
	...
	def sort(self, key: Callable[[T_Value], Any] | None = None) -> None: ...
	def reverse(self) -> None: ...
	def pop(self, index: int = -1) -> T_Value: ...
	def clear(self) -> None: ...
	def copy(self) -> list[T_Value]: ...


@__actual__('dict')
class Dict[T_Key, T_Value](Sequence[tuple[T_Key, T_Value]]):
	...
	def clear(self) -> None: ...
	def copy(self) -> dict[T_Key, T_Value]: ...
	def update(self, other: dict[T_Key, T_Value]) -> None: ...
...
def enumerate[T](iterable: Sequence[T]) -> Iterator[tuple[int, T]]: ...
