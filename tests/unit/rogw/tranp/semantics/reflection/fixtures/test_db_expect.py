def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#P': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#P', 'P'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<P>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H', 'H'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H.callback': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H.callback', 'callback(H, bool) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke', 'invoke(Delegate<P>, args, kwargs) -> None'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind', 'bind(Delegate<P>, T, Callable<P, None>) -> T'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind_call': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind_call', 'bind_call(Delegate<P>, H) -> None'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#ParamSpec': ('typing#ParamSpec', 'ParamSpec'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3735.f': ('typing#IO', 'IO'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#WithOps.file_load.with@3735.content': ('rogw.tranp.compatible.libralies.classes#dict', 'dict<str, Any>'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H.callback.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H', 'H'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H.callback.b': ('rogw.tranp.compatible.libralies.classes#bool', 'bool'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<P>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke.args': ('typing#ParamSpec.args', 'args'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke.kwargs': ('typing#ParamSpec.kwargs', 'kwargs'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<P>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind.obj': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#T', 'T'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind.method': ('typing#Callable', 'Callable<P, None>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind_call.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<P>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind_call.h': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.H', 'H'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.bind_call.d': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<bool>'),
