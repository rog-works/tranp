...
class TestSymbolDB(TestCase):
	...
	@data_provider([
		({
			...
			'__main__.B.func2.for(329).i': 'py2cpp.compatible.python.template.T_Seq',  # FIXME 追って修正
			'__main__.B.func2.try(369).e': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Exception',
			'__main__.B.func2.closure.a': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			# エントリーポイント(FuncCall/Literal)
			'__main__.A.__init__.str': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.str',
			'__main__.B.B2.str': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.str',
			...
			'__main__.B.func1.bool': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.bool',
			...
			'__main__.B.func1.int': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			'__main__.B.func1.func_call(235)': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.None',
			'__main__.B.func1.str': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.str',
			'__main__.B.func2.closure.int': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			'__main__.B.func2.for(329).int': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			'__main__.B.func2.for(329).func_call(333)': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.Iterator',
			'__main__.B.func2.for(329).func_call(342)': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.None',
			'__main__.B.func2.for(329).if(351).int': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			'__main__.B.func2.for(329).if(351).func_call(362)': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
			'__main__.B.func2.try(369).while(371).bool': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.bool',
			'__main__.B.func2.try(369).while(371).if(374).int': 'tests.unit.py2cpp.analize.fixtures.test_db_classes.int',
