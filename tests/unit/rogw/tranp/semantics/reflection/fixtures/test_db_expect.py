def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'rogw.tranp.compatible.cpp.object#CRef.copy': ('rogw.tranp.compatible.cpp.object#CRef.copy', 'copy(CRef<T_co>, CRef<T_co>) -> None'),
		...
		'rogw.tranp.compatible.cpp.object#CRef.copy.self': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.copy.via': ('rogw.tranp.compatible.cpp.object#CRef', 'CRef<T_co>'),
		'rogw.tranp.compatible.cpp.object#CRef.copy.if@1386.if_clause@1387.copy_origin': ('collections.abc#Callable', 'Callable<CRef<T_co>, None>'),
