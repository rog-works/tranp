def expected_symbols() -> dict:
	return {
		...
		'__main__.Comp.dict_comp.dict_comp@1364.index': 'rogw.tranp.compatible.python.classes.str',
		'__main__.Comp.dict_comp.dict_comp@1364.key': 'rogw.tranp.compatible.python.classes.int',
