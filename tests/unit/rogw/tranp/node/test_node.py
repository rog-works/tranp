...
""",
			...
			[
				...
				'          | +-else_ifs:',
				'          | +-else_statements:',
				'          +-<For: __main__.A.__init__.for@86>',
				'            +-symbols:',
				'            | +-<DeclLocalVar: __main__.A.__init__.for.key>',
				'            | +-<DeclLocalVar: __main__.A.__init__.for.value>',
				'            +-for_in: <ForIn: __main__.A.__init__.for.for_in@92>',
				'            | +-iterates: <FuncCall: __main__.A.__init__.for.func_call@93>',
				"            |   +-calls: <Relay: __main__.A.__init__.for.dict@95.items>",
				'            |   | +-receiver: <Dict: __main__.A.__init__.for.dict@95>',
				'            |   |   +-items:',
				'            |   |     +-<Pair: __main__.A.__init__.for.Pair@96>',
				'            |   |       +-first: <String: __main__.A.__init__.for.str@97>',
				'            |   |       +-second: <Integer: __main__.A.__init__.for.int@99>',
				'            |   +-arguments:',
				'            +-statements:',
				'              +-<Elipsis: __main__.A.__init__.for.elipsis@105>',
			],
	),])
