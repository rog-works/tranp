...
class TestRenderer(TestCase):
	...
	@data_provider([
		...
		({'receiver': 'p', 'arguments': ['int'], 'cvar_type': 'CSP', 'is_statement': True}, 'dynamic_pointer_cast<int>(p);'),
	])
	...
	@data_provider([
		...
		({'receiver': 'p', 'arguments': ['int'], 'cvar_type': 'CSP', 'is_statement': True}, 'static_pointer_cast<int>(p);'),
	])
