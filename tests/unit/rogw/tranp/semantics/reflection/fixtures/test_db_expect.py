def expected_symbols() -> dict[str, tuple[str, str]]:
	return {
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke_call': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke_call', 'invoke_call(Delegate<P>) -> None'),
		...
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke_call.self': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<P>'),
		'tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate.invoke_call.d': ('tests.unit.rogw.tranp.semantics.reflection.fixtures.test_db#Delegate', 'Delegate<bool>'),
